...
export class IamAccountSettingsTemplateAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IamAccountSettingsTemplateAssignmentState, opts?: pulumi.CustomResourceOptions): IamAccountSettingsTemplateAssignment {
        return new IamAccountSettingsTemplateAssignment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/iamAccountSettingsTemplateAssignment:IamAccountSettingsTemplateAssignment';

    /**
     * Returns true if the given object is an instance of IamAccountSettingsTemplateAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IamAccountSettingsTemplateAssignment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IamAccountSettingsTemplateAssignment.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly resources: pulumi.Output<outputs.IamAccountSettingsTemplateAssignmentResource[]>;
    /**
     * Assignment status.
     */
    ...
    /**
     * Create a IamAccountSettingsTemplateAssignment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IamAccountSettingsTemplateAssignmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IamAccountSettingsTemplateAssignmentArgs | IamAccountSettingsTemplateAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as IamAccountSettingsTemplateAssignmentArgs | undefined;
        ...
        super(IamAccountSettingsTemplateAssignment.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IamAccountSettingsTemplateAssignmentState {
    /**
     * Enterprise account Id.
     */
 ...
 */
export interface IamAccountSettingsTemplateAssignmentArgs {
    /**
     * Assignment target.
     */
    target: pulumi.Input<string>;
