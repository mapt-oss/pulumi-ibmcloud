...
export class PagInstance extends pulumi.CustomResource {
    /**
     * Get an existing PagInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PagInstanceState, opts?: pulumi.CustomResourceOptions): PagInstance {
        return new PagInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/pagInstance:PagInstance';

    /**
     * Returns true if the given object is an instance of PagInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PagInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PagInstance.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly planHistories: pulumi.Output<outputs.PagInstancePlanHistory[]>;
    /**
    ...
    /**
     * Create a PagInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PagInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PagInstanceArgs | PagInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PagInstanceState | undefined;
            ...
            const args = argsOrState as PagInstanceArgs | undefined;
        ...
        super(PagInstance.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PagInstanceState {
    /**
     * An alpha-numeric value identifying the account ID.
     */
     ...
     * The plan history of the instance.
     */
    planHistories?: pulumi.Input<pulumi.Input<inputs.PagInstancePlanHistory>[]>;
    /**
     * The relative path to the resource aliases for the instance.
     *
     * @deprecated Remove this attribute's configuration as it's no longer in use and the attribute will be removed in the upcoming major version of the provider 1.71.0.
 ...
 */
export interface PagInstanceArgs {
    /**
     * The location where the instance available
     */
    location: pulumi.Input<string>;
