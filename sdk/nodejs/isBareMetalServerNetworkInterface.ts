...
export class IsBareMetalServerNetworkInterface extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IsBareMetalServerNetworkInterfaceState, opts?: pulumi.CustomResourceOptions): IsBareMetalServerNetworkInterface {
        return new IsBareMetalServerNetworkInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/isBareMetalServerNetworkInterface:IsBareMetalServerNetworkInterface';

    /**
     * Returns true if the given object is an instance of IsBareMetalServerNetworkInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IsBareMetalServerNetworkInterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IsBareMetalServerNetworkInterface.__pulumiType;
    }
     ...
     */
    declare public readonly allowInterfaceToFloat: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly allowedVlans: pulumi.Output<number[]>;
    /**
     ...
     */
    declare public /*out*/ readonly floatingIps: pulumi.Output<outputs.IsBareMetalServerNetworkInterfaceFloatingIp[]>;
    /**
     ...
     */
    declare public readonly primaryIp: pulumi.Output<outputs.IsBareMetalServerNetworkInterfacePrimaryIp>;
    /**
    ...
    /**
     * Create a IsBareMetalServerNetworkInterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IsBareMetalServerNetworkInterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IsBareMetalServerNetworkInterfaceArgs | IsBareMetalServerNetworkInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IsBareMetalServerNetworkInterfaceState | undefined;
            ...
            const args = argsOrState as IsBareMetalServerNetworkInterfaceArgs | undefined;
            ...
            resourceInputs["allowInterfaceToFloat"] = args?.allowInterfaceToFloat;
        ...
        super(IsBareMetalServerNetworkInterface.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IsBareMetalServerNetworkInterfaceState {
    /**
     * Indicates if the interface can float to any other server within the same resource_group. The interface will float automatically if the network detects a GARP or RARP on another bare metal server in the resource group. Applies only to vlan type interfaces.
     */
     ...
     * The floating IPs associated with this network interface.
     */
    floatingIps?: pulumi.Input<pulumi.Input<inputs.IsBareMetalServerNetworkInterfaceFloatingIp>[]>;
    /**
     * Only used for PCI network interfaces, whether to hard/immediately stop server
     */
 ...
 */
export interface IsBareMetalServerNetworkInterfaceArgs {
    /**
     * Indicates if the interface can float to any other server within the same resource_group. The interface will float automatically if the network detects a GARP or RARP on another bare metal server in the resource group. Applies only to vlan type interfaces.
     */
    allowInterfaceToFloat?: pulumi.Input<boolean>;
