...
export class IsImageDeprecate extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IsImageDeprecateState, opts?: pulumi.CustomResourceOptions): IsImageDeprecate {
        return new IsImageDeprecate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/isImageDeprecate:IsImageDeprecate';

    /**
     * Returns true if the given object is an instance of IsImageDeprecate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IsImageDeprecate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IsImageDeprecate.__pulumiType;
    }
    ...
    /**
     * Create a IsImageDeprecate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IsImageDeprecateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IsImageDeprecateArgs | IsImageDeprecateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IsImageDeprecateState | undefined;
            ...
            const args = argsOrState as IsImageDeprecateArgs | undefined;
        ...
        super(IsImageDeprecate.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IsImageDeprecateState {
    /**
     * List of access management tags
     */
 ...
 */
export interface IsImageDeprecateArgs {
    /**
     * Image identifier
     */
    image: pulumi.Input<string>;
