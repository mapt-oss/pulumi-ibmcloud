...
export class IamActionControlTemplate extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IamActionControlTemplateState, opts?: pulumi.CustomResourceOptions): IamActionControlTemplate {
        return new IamActionControlTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/iamActionControlTemplate:IamActionControlTemplate';

    /**
     * Returns true if the given object is an instance of IamActionControlTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IamActionControlTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IamActionControlTemplate.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly actionControlTemplateId: pulumi.Output<string>;
    /**
     * The action control properties that are created in an action resource when the template is assigned.
     */
    declare public readonly actionControls: pulumi.Output<outputs.IamActionControlTemplateActionControl[] | undefined>;
    /**
    ...
    /**
     * Create a IamActionControlTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: IamActionControlTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IamActionControlTemplateArgs | IamActionControlTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IamActionControlTemplateState | undefined;
            ...
            const args = argsOrState as IamActionControlTemplateArgs | undefined;
            resourceInputs["actionControls"] = args?.actionControls;
            resourceInputs["committed"] = args?.committed;
            resourceInputs["description"] = args?.description;
            resourceInputs["name"] = args?.name;
            resourceInputs["accountId"] = undefined /*out*/;
            resourceInputs["actionControlTemplateId"] = undefined /*out*/;
        ...
        super(IamActionControlTemplate.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IamActionControlTemplateState {
    /**
     * Enterprise account ID where this template is created.
     */
 ...
 */
export interface IamActionControlTemplateArgs {
    /**
     * The action control properties that are created in an action resource when the template is assigned.
     */
    actionControls?: pulumi.Input<pulumi.Input<inputs.IamActionControlTemplateActionControl>[]>;
