...
export class Cloudant extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudantState, opts?: pulumi.CustomResourceOptions): Cloudant {
        return new Cloudant(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/cloudant:Cloudant';

    /**
     * Returns true if the given object is an instance of Cloudant.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Cloudant {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Cloudant.__pulumiType;
    }
     ...
     */
    declare public readonly corsConfig: pulumi.Output<outputs.CloudantCorsConfig | undefined>;
    /**
     ...
     */
    declare public readonly environmentCrn: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly includeDataEvents: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly legacyCredentials: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly planHistories: pulumi.Output<outputs.CloudantPlanHistory[]>;
    /**
     ...
     */
    declare public /*out*/ readonly throughput: pulumi.Output<{[key: string]: number}>;
    /**
    ...
    /**
     * Create a Cloudant resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudantArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudantArgs | CloudantState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudantState | undefined;
            ...
            resourceInputs["environmentCrn"] = state?.environmentCrn;
            resourceInputs["extensions"] = state?.extensions;
            resourceInputs["guid"] = state?.guid;
            resourceInputs["includeDataEvents"] = state?.includeDataEvents;
            resourceInputs["lastOperation"] = state?.lastOperation;
            resourceInputs["legacyCredentials"] = state?.legacyCredentials;
            ...
            const args = argsOrState as CloudantArgs | undefined;
            ...
            resourceInputs["environmentCrn"] = args?.environmentCrn;
            resourceInputs["includeDataEvents"] = args?.includeDataEvents;
            resourceInputs["legacyCredentials"] = args?.legacyCredentials;
        ...
        super(Cloudant.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CloudantState {
    /**
     * An alpha-numeric value identifying the account ID.
     */
     ...
     * Configuration for CORS.
     */
    corsConfig?: pulumi.Input<inputs.CloudantCorsConfig>;
    /**
     * The date when the instance was created.
     */
     ...
     * Include data event types in events sent to IBM Cloud Activity Tracker with LogDNA for the IBM Cloudant instance. By default only emitted events are of "management" type.
     */
    includeDataEvents?: pulumi.Input<boolean>;
    /**
     * The status of the last operation requested on the instance
     */
     ...
     * Use both legacy credentials and IAM for authentication
     */
    legacyCredentials?: pulumi.Input<boolean>;
    /**
     * The location where the instance available
     */
     ...
     * The plan history of the instance.
     */
    planHistories?: pulumi.Input<pulumi.Input<inputs.CloudantPlanHistory>[]>;
    /**
     * The relative path to the resource aliases for the instance.
     *
     * @deprecated Remove this attribute's configuration as it's no longer in use and the attribute will be removed in the upcoming major version of the provider 1.71.0.
     ...
     * Schema for detailed information about throughput capacity with breakdown by specific throughput requests classes.
     */
    throughput?: pulumi.Input<{[key: string]: pulumi.Input<number>}>;
    /**
     * The type of the instance, e.g. service_instance.
     */
