...
export class IsSubnetReservedIp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IsSubnetReservedIpState, opts?: pulumi.CustomResourceOptions): IsSubnetReservedIp {
        return new IsSubnetReservedIp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ibmcloud:index/isSubnetReservedIp:IsSubnetReservedIp';

    /**
     * Returns true if the given object is an instance of IsSubnetReservedIp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IsSubnetReservedIp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IsSubnetReservedIp.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly reservedIp: pulumi.Output<string>;
    /**
     * The resource type.
     */
    ...
    /**
     * Create a IsSubnetReservedIp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IsSubnetReservedIpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IsSubnetReservedIpArgs | IsSubnetReservedIpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IsSubnetReservedIpState | undefined;
            ...
            const args = argsOrState as IsSubnetReservedIpArgs | undefined;
        ...
        super(IsSubnetReservedIp.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IsSubnetReservedIpState {
    /**
     * The address for this reserved IP.
     */
 ...
 */
export interface IsSubnetReservedIpArgs {
    /**
     * The address for this reserved IP.
     */
    address?: pulumi.Input<string>;
