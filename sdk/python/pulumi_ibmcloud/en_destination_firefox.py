...
__all__ = ['EnDestinationFirefoxArgs', 'EnDestinationFirefox']

@pulumi.input_type
class EnDestinationFirefoxArgs:
    def __init__(__self__, *,
                 instance_guid: pulumi.Input[_builtins.str],
                 type: pulumi.Input[_builtins.str],
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationFirefoxConfigArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: The type of Destination type push_firefox.
        ...
        :param pulumi.Input['EnDestinationFirefoxConfigArgs'] config: Payload describing a destination configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> Optional[pulumi.Input['EnDestinationFirefoxConfigArgs']]:
        """
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input['EnDestinationFirefoxConfigArgs']]):
...
@pulumi.input_type
class _EnDestinationFirefoxState:
    def __init__(__self__, *,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationFirefoxConfigArgs']] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("ibmcloud:index/enDestinationFirefox:EnDestinationFirefox")
class EnDestinationFirefox(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input[Union['EnDestinationFirefoxConfigArgs', 'EnDestinationFirefoxConfigArgsDict']]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnDestinationFirefox resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] collect_failed_events: Whether to collect the failed event in Cloud Object Storage bucket
        :param pulumi.Input[Union['EnDestinationFirefoxConfigArgs', 'EnDestinationFirefoxConfigArgsDict']] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] description: The Destination description.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] name: The Destintion name.
        :param pulumi.Input[_builtins.str] type: The type of Destination type push_firefox.
    ...
    def __init__(__self__,
        ...
        Create a EnDestinationFirefox resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnDestinationFirefoxArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnDestinationFirefoxArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnDestinationFirefoxArgs.__new__(EnDestinationFirefoxArgs)
        ...
        super(EnDestinationFirefox, __self__).__init__(
            'ibmcloud:index/enDestinationFirefox:EnDestinationFirefox',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subscription_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnDestinationFirefox':
        """
        ...
        __props__ = _EnDestinationFirefoxState.__new__(_EnDestinationFirefoxState)
        ...
        return EnDestinationFirefox(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output[Optional['outputs.EnDestinationFirefoxConfig']]:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
