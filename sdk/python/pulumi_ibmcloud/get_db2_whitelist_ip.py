...
def get_db2_whitelist_ip(x_deployment_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getDb2WhitelistIp:getDb2WhitelistIp', __args__, opts=opts, typ=GetDb2WhitelistIpResult).value

    return AwaitableGetDb2WhitelistIpResult(
        id=pulumi.get(__ret__, 'id'),
        ip_addresses=pulumi.get(__ret__, 'ip_addresses'),
        x_deployment_id=pulumi.get(__ret__, 'x_deployment_id'))
def get_db2_whitelist_ip_output(x_deployment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getDb2WhitelistIp:getDb2WhitelistIp', __args__, opts=opts, typ=GetDb2WhitelistIpResult)
