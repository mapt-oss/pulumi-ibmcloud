...
__all__ = [
    'GetCdToolchainToolPrivateworkerResult',
    'AwaitableGetCdToolchainToolPrivateworkerResult',
    'get_cd_toolchain_tool_privateworker',
    'get_cd_toolchain_tool_privateworker_output',
]

@pulumi.output_type
class GetCdToolchainToolPrivateworkerResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolPrivateworkerParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolPrivateworkerReferentResult']:
...
class AwaitableGetCdToolchainToolPrivateworkerResult(GetCdToolchainToolPrivateworkerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolPrivateworkerResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_privateworker(tool_id: Optional[_builtins.str] = None,
                                        toolchain_id: Optional[_builtins.str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolPrivateworkerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolPrivateworker:getCdToolchainToolPrivateworker', __args__, opts=opts, typ=GetCdToolchainToolPrivateworkerResult).value

    return AwaitableGetCdToolchainToolPrivateworkerResult(
...
def get_cd_toolchain_tool_privateworker_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                               toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolPrivateworkerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolPrivateworker:getCdToolchainToolPrivateworker', __args__, opts=opts, typ=GetCdToolchainToolPrivateworkerResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolPrivateworkerResult(
