...
__all__ = [
    'GetEnDestinationCosResult',
    'AwaitableGetEnDestinationCosResult',
    'get_en_destination_cos',
    'get_en_destination_cos_output',
]

@pulumi.output_type
class GetEnDestinationCosResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationCosConfigResult']:
...
class AwaitableGetEnDestinationCosResult(GetEnDestinationCosResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationCosResult(
...
def get_en_destination_cos(destination_id: Optional[_builtins.str] = None,
                           instance_guid: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationCosResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationCos:getEnDestinationCos', __args__, opts=opts, typ=GetEnDestinationCosResult).value

    return AwaitableGetEnDestinationCosResult(
...
def get_en_destination_cos_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationCosResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationCos:getEnDestinationCos', __args__, opts=opts, typ=GetEnDestinationCosResult)
    return __ret__.apply(lambda __response__: GetEnDestinationCosResult(
