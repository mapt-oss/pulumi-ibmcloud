...
__all__ = [
    'GetSmKvSecretMetadataResult',
    'AwaitableGetSmKvSecretMetadataResult',
    'get_sm_kv_secret_metadata',
    'get_sm_kv_secret_metadata_output',
]

@pulumi.output_type
class GetSmKvSecretMetadataResult:
    """
    A collection of values returned by getSmKvSecretMetadata.
    """
    def __init__(__self__, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, region=None, retrieved_at=None, secret_group_id=None, secret_id=None, secret_type=None, state=None, state_description=None, updated_at=None, versions_total=None):
...
class AwaitableGetSmKvSecretMetadataResult(GetSmKvSecretMetadataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmKvSecretMetadataResult(
...
def get_sm_kv_secret_metadata(endpoint_type: Optional[_builtins.str] = None,
                              instance_id: Optional[_builtins.str] = None,
                              region: Optional[_builtins.str] = None,
                              secret_id: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmKvSecretMetadataResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmKvSecretMetadata:getSmKvSecretMetadata', __args__, opts=opts, typ=GetSmKvSecretMetadataResult).value

    return AwaitableGetSmKvSecretMetadataResult(
...
def get_sm_kv_secret_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     secret_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmKvSecretMetadataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmKvSecretMetadata:getSmKvSecretMetadata', __args__, opts=opts, typ=GetSmKvSecretMetadataResult)
    return __ret__.apply(lambda __response__: GetSmKvSecretMetadataResult(
