...
__all__ = [
    'GetEnWebhookTemplateResult',
    'AwaitableGetEnWebhookTemplateResult',
    'get_en_webhook_template',
    'get_en_webhook_template_output',
]

@pulumi.output_type
class GetEnWebhookTemplateResult:
    """
...
class AwaitableGetEnWebhookTemplateResult(GetEnWebhookTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnWebhookTemplateResult(
...
def get_en_webhook_template(instance_guid: Optional[_builtins.str] = None,
                            template_id: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnWebhookTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnWebhookTemplate:getEnWebhookTemplate', __args__, opts=opts, typ=GetEnWebhookTemplateResult).value

    return AwaitableGetEnWebhookTemplateResult(
...
def get_en_webhook_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                   template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnWebhookTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnWebhookTemplate:getEnWebhookTemplate', __args__, opts=opts, typ=GetEnWebhookTemplateResult)
    return __ret__.apply(lambda __response__: GetEnWebhookTemplateResult(
