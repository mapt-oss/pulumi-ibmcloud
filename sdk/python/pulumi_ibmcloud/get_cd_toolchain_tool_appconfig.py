...
__all__ = [
    'GetCdToolchainToolAppconfigResult',
    'AwaitableGetCdToolchainToolAppconfigResult',
    'get_cd_toolchain_tool_appconfig',
    'get_cd_toolchain_tool_appconfig_output',
]

@pulumi.output_type
class GetCdToolchainToolAppconfigResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolAppconfigParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolAppconfigReferentResult']:
...
class AwaitableGetCdToolchainToolAppconfigResult(GetCdToolchainToolAppconfigResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolAppconfigResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_appconfig(tool_id: Optional[_builtins.str] = None,
                                    toolchain_id: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolAppconfigResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolAppconfig:getCdToolchainToolAppconfig', __args__, opts=opts, typ=GetCdToolchainToolAppconfigResult).value

    return AwaitableGetCdToolchainToolAppconfigResult(
...
def get_cd_toolchain_tool_appconfig_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolAppconfigResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolAppconfig:getCdToolchainToolAppconfig', __args__, opts=opts, typ=GetCdToolchainToolAppconfigResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolAppconfigResult(
