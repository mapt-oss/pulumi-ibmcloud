...
__all__ = [
    'GetEnDestinationCeResult',
    'AwaitableGetEnDestinationCeResult',
    'get_en_destination_ce',
    'get_en_destination_ce_output',
]

@pulumi.output_type
class GetEnDestinationCeResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationCeConfigResult']:
...
class AwaitableGetEnDestinationCeResult(GetEnDestinationCeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationCeResult(
...
def get_en_destination_ce(destination_id: Optional[_builtins.str] = None,
                          instance_guid: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationCeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationCe:getEnDestinationCe', __args__, opts=opts, typ=GetEnDestinationCeResult).value

    return AwaitableGetEnDestinationCeResult(
...
def get_en_destination_ce_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationCeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationCe:getEnDestinationCe', __args__, opts=opts, typ=GetEnDestinationCeResult)
    return __ret__.apply(lambda __response__: GetEnDestinationCeResult(
