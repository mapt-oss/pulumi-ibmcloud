...
def get_kms_kmip_adapters(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getKmsKmipAdapters:getKmsKmipAdapters', __args__, opts=opts, typ=GetKmsKmipAdaptersResult).value
...
def get_kms_kmip_adapters_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getKmsKmipAdapters:getKmsKmipAdapters', __args__, opts=opts, typ=GetKmsKmipAdaptersResult)
