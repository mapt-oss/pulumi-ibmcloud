...
__all__ = [
    'GetIsVpcRoutingTableResult',
    'AwaitableGetIsVpcRoutingTableResult',
    'get_is_vpc_routing_table',
    'get_is_vpc_routing_table_output',
]

@pulumi.output_type
class GetIsVpcRoutingTableResult:
    """
    A collection of values returned by getIsVpcRoutingTable.
    """
    def __init__(__self__, accept_routes_froms=None, access_tags=None, advertise_routes_tos=None, created_at=None, crn=None, href=None, id=None, is_default=None, lifecycle_state=None, name=None, resource_groups=None, resource_type=None, route_direct_link_ingress=None, route_internet_ingress=None, route_transit_gateway_ingress=None, route_vpc_zone_ingress=None, routes=None, routing_table=None, subnets=None, tags=None, vpc=None):
        if accept_routes_froms and not isinstance(accept_routes_froms, list):
            raise TypeError("Expected argument 'accept_routes_froms' to be a list")
        pulumi.set(__self__, "accept_routes_froms", accept_routes_froms)
        ...
        if advertise_routes_tos and not isinstance(advertise_routes_tos, list):
            raise TypeError("Expected argument 'advertise_routes_tos' to be a list")
    ...
    @_builtins.property
    @pulumi.getter(name="acceptRoutesFroms")
    def accept_routes_froms(self) -> Sequence['outputs.GetIsVpcRoutingTableAcceptRoutesFromResult']:
        return pulumi.get(self, "accept_routes_froms")
    ...
    def advertise_routes_tos(self) -> Sequence[_builtins.str]:
    ...
    def resource_groups(self) -> Sequence['outputs.GetIsVpcRoutingTableResourceGroupResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def routes(self) -> Sequence['outputs.GetIsVpcRoutingTableRouteResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def subnets(self) -> Sequence['outputs.GetIsVpcRoutingTableSubnetResult']:
...
class AwaitableGetIsVpcRoutingTableResult(GetIsVpcRoutingTableResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIsVpcRoutingTableResult(
            accept_routes_froms=self.accept_routes_froms,
            access_tags=self.access_tags,
            advertise_routes_tos=self.advertise_routes_tos,
...
def get_is_vpc_routing_table(name: Optional[_builtins.str] = None,
                             routing_table: Optional[_builtins.str] = None,
                             vpc: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIsVpcRoutingTableResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getIsVpcRoutingTable:getIsVpcRoutingTable', __args__, opts=opts, typ=GetIsVpcRoutingTableResult).value

    return AwaitableGetIsVpcRoutingTableResult(
        accept_routes_froms=pulumi.get(__ret__, 'accept_routes_froms'),
        access_tags=pulumi.get(__ret__, 'access_tags'),
        advertise_routes_tos=pulumi.get(__ret__, 'advertise_routes_tos'),
...
def get_is_vpc_routing_table_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getIsVpcRoutingTable:getIsVpcRoutingTable', __args__, opts=opts, typ=GetIsVpcRoutingTableResult)
    return __ret__.apply(lambda __response__: GetIsVpcRoutingTableResult(
        accept_routes_froms=pulumi.get(__response__, 'accept_routes_froms'),
        access_tags=pulumi.get(__response__, 'access_tags'),
        advertise_routes_tos=pulumi.get(__response__, 'advertise_routes_tos'),
