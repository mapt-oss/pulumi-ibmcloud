...
__all__ = [
    'GetCdToolchainToolCosResult',
    'AwaitableGetCdToolchainToolCosResult',
    'get_cd_toolchain_tool_cos',
    'get_cd_toolchain_tool_cos_output',
]

@pulumi.output_type
class GetCdToolchainToolCosResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolCosParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolCosReferentResult']:
...
class AwaitableGetCdToolchainToolCosResult(GetCdToolchainToolCosResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolCosResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_cos(tool_id: Optional[_builtins.str] = None,
                              toolchain_id: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolCosResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolCos:getCdToolchainToolCos', __args__, opts=opts, typ=GetCdToolchainToolCosResult).value

    return AwaitableGetCdToolchainToolCosResult(
...
def get_cd_toolchain_tool_cos_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolCosResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolCos:getCdToolchainToolCos', __args__, opts=opts, typ=GetCdToolchainToolCosResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolCosResult(
