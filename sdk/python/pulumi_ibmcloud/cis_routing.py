...
__all__ = ['CisRoutingArgs', 'CisRouting']

@pulumi.input_type
class CisRoutingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] smart_routing: Smart Routing value
        """
...
@pulumi.type_token("ibmcloud:index/cisRouting:CisRouting")
class CisRouting(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CisRouting resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a CisRouting resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CisRoutingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CisRoutingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CisRoutingArgs.__new__(CisRoutingArgs)
        ...
        super(CisRouting, __self__).__init__(
            'ibmcloud:index/cisRouting:CisRouting',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            cis_id: Optional[pulumi.Input[_builtins.str]] = None,
            domain_id: Optional[pulumi.Input[_builtins.str]] = None,
            smart_routing: Optional[pulumi.Input[_builtins.str]] = None) -> 'CisRouting':
        """
        ...
        __props__ = _CisRoutingState.__new__(_CisRoutingState)

        __props__.__dict__["cis_id"] = cis_id
        __props__.__dict__["domain_id"] = domain_id
        __props__.__dict__["smart_routing"] = smart_routing
        return CisRouting(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="smartRouting")
    def smart_routing(self) -> pulumi.Output[_builtins.str]:
        """
        Smart Routing value
        """
        return pulumi.get(self, "smart_routing")
