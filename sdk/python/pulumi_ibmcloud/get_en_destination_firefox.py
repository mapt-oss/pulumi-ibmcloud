...
__all__ = [
    'GetEnDestinationFirefoxResult',
    'AwaitableGetEnDestinationFirefoxResult',
    'get_en_destination_firefox',
    'get_en_destination_firefox_output',
]

@pulumi.output_type
class GetEnDestinationFirefoxResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationFirefoxConfigResult']:
...
class AwaitableGetEnDestinationFirefoxResult(GetEnDestinationFirefoxResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationFirefoxResult(
...
def get_en_destination_firefox(destination_id: Optional[_builtins.str] = None,
                               instance_guid: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationFirefoxResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationFirefox:getEnDestinationFirefox', __args__, opts=opts, typ=GetEnDestinationFirefoxResult).value

    return AwaitableGetEnDestinationFirefoxResult(
...
def get_en_destination_firefox_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationFirefoxResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationFirefox:getEnDestinationFirefox', __args__, opts=opts, typ=GetEnDestinationFirefoxResult)
    return __ret__.apply(lambda __response__: GetEnDestinationFirefoxResult(
