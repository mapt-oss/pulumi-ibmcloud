...
__all__ = [
    'GetEnDestinationCustomEmailResult',
    'AwaitableGetEnDestinationCustomEmailResult',
    'get_en_destination_custom_email',
    'get_en_destination_custom_email_output',
]

@pulumi.output_type
class GetEnDestinationCustomEmailResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationCustomEmailConfigResult']:
...
class AwaitableGetEnDestinationCustomEmailResult(GetEnDestinationCustomEmailResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationCustomEmailResult(
...
def get_en_destination_custom_email(destination_id: Optional[_builtins.str] = None,
                                    instance_guid: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationCustomEmailResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationCustomEmail:getEnDestinationCustomEmail', __args__, opts=opts, typ=GetEnDestinationCustomEmailResult).value

    return AwaitableGetEnDestinationCustomEmailResult(
...
def get_en_destination_custom_email_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationCustomEmailResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationCustomEmail:getEnDestinationCustomEmail', __args__, opts=opts, typ=GetEnDestinationCustomEmailResult)
    return __ret__.apply(lambda __response__: GetEnDestinationCustomEmailResult(
