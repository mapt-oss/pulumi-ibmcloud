...
__all__ = [
    'GetEnCodeEngineTemplateResult',
    'AwaitableGetEnCodeEngineTemplateResult',
    'get_en_code_engine_template',
    'get_en_code_engine_template_output',
]

@pulumi.output_type
class GetEnCodeEngineTemplateResult:
    """
...
class AwaitableGetEnCodeEngineTemplateResult(GetEnCodeEngineTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnCodeEngineTemplateResult(
...
def get_en_code_engine_template(instance_guid: Optional[_builtins.str] = None,
                                template_id: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnCodeEngineTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnCodeEngineTemplate:getEnCodeEngineTemplate', __args__, opts=opts, typ=GetEnCodeEngineTemplateResult).value

    return AwaitableGetEnCodeEngineTemplateResult(
...
def get_en_code_engine_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                       template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnCodeEngineTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnCodeEngineTemplate:getEnCodeEngineTemplate', __args__, opts=opts, typ=GetEnCodeEngineTemplateResult)
    return __ret__.apply(lambda __response__: GetEnCodeEngineTemplateResult(
