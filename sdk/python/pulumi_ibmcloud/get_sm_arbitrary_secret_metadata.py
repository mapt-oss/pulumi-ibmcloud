...
__all__ = [
    'GetSmArbitrarySecretMetadataResult',
    'AwaitableGetSmArbitrarySecretMetadataResult',
    'get_sm_arbitrary_secret_metadata',
    'get_sm_arbitrary_secret_metadata_output',
]

@pulumi.output_type
class GetSmArbitrarySecretMetadataResult:
    """
    A collection of values returned by getSmArbitrarySecretMetadata.
    """
    def __init__(__self__, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, region=None, retrieved_at=None, secret_group_id=None, secret_id=None, secret_type=None, state=None, state_description=None, updated_at=None, versions_total=None):
...
class AwaitableGetSmArbitrarySecretMetadataResult(GetSmArbitrarySecretMetadataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmArbitrarySecretMetadataResult(
...
def get_sm_arbitrary_secret_metadata(endpoint_type: Optional[_builtins.str] = None,
                                     instance_id: Optional[_builtins.str] = None,
                                     region: Optional[_builtins.str] = None,
                                     secret_id: Optional[_builtins.str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmArbitrarySecretMetadataResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmArbitrarySecretMetadata:getSmArbitrarySecretMetadata', __args__, opts=opts, typ=GetSmArbitrarySecretMetadataResult).value

    return AwaitableGetSmArbitrarySecretMetadataResult(
...
def get_sm_arbitrary_secret_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            secret_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmArbitrarySecretMetadataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmArbitrarySecretMetadata:getSmArbitrarySecretMetadata', __args__, opts=opts, typ=GetSmArbitrarySecretMetadataResult)
    return __ret__.apply(lambda __response__: GetSmArbitrarySecretMetadataResult(
