...
__all__ = [
    'GetCdToolchainToolGithubconsolidatedResult',
    'AwaitableGetCdToolchainToolGithubconsolidatedResult',
    'get_cd_toolchain_tool_githubconsolidated',
    'get_cd_toolchain_tool_githubconsolidated_output',
]

@pulumi.output_type
class GetCdToolchainToolGithubconsolidatedResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolGithubconsolidatedParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolGithubconsolidatedReferentResult']:
...
class AwaitableGetCdToolchainToolGithubconsolidatedResult(GetCdToolchainToolGithubconsolidatedResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolGithubconsolidatedResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_githubconsolidated(tool_id: Optional[_builtins.str] = None,
                                             toolchain_id: Optional[_builtins.str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolGithubconsolidatedResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolGithubconsolidated:getCdToolchainToolGithubconsolidated', __args__, opts=opts, typ=GetCdToolchainToolGithubconsolidatedResult).value

    return AwaitableGetCdToolchainToolGithubconsolidatedResult(
...
def get_cd_toolchain_tool_githubconsolidated_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolGithubconsolidatedResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolGithubconsolidated:getCdToolchainToolGithubconsolidated', __args__, opts=opts, typ=GetCdToolchainToolGithubconsolidatedResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolGithubconsolidatedResult(
