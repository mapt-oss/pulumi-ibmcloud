...
__all__ = [
    'GetCdToolchainToolJenkinsResult',
    'AwaitableGetCdToolchainToolJenkinsResult',
    'get_cd_toolchain_tool_jenkins',
    'get_cd_toolchain_tool_jenkins_output',
]

@pulumi.output_type
class GetCdToolchainToolJenkinsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolJenkinsParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolJenkinsReferentResult']:
...
class AwaitableGetCdToolchainToolJenkinsResult(GetCdToolchainToolJenkinsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolJenkinsResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_jenkins(tool_id: Optional[_builtins.str] = None,
                                  toolchain_id: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolJenkinsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolJenkins:getCdToolchainToolJenkins', __args__, opts=opts, typ=GetCdToolchainToolJenkinsResult).value

    return AwaitableGetCdToolchainToolJenkinsResult(
...
def get_cd_toolchain_tool_jenkins_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolJenkinsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolJenkins:getCdToolchainToolJenkins', __args__, opts=opts, typ=GetCdToolchainToolJenkinsResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolJenkinsResult(
