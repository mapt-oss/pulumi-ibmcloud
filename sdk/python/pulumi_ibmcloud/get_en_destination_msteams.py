...
__all__ = [
    'GetEnDestinationMsteamsResult',
    'AwaitableGetEnDestinationMsteamsResult',
    'get_en_destination_msteams',
    'get_en_destination_msteams_output',
]

@pulumi.output_type
class GetEnDestinationMsteamsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationMsteamsConfigResult']:
...
class AwaitableGetEnDestinationMsteamsResult(GetEnDestinationMsteamsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationMsteamsResult(
...
def get_en_destination_msteams(destination_id: Optional[_builtins.str] = None,
                               instance_guid: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationMsteamsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationMsteams:getEnDestinationMsteams', __args__, opts=opts, typ=GetEnDestinationMsteamsResult).value

    return AwaitableGetEnDestinationMsteamsResult(
...
def get_en_destination_msteams_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationMsteamsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationMsteams:getEnDestinationMsteams', __args__, opts=opts, typ=GetEnDestinationMsteamsResult)
    return __ret__.apply(lambda __response__: GetEnDestinationMsteamsResult(
