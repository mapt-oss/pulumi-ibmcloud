...
__all__ = [
    'GetEnDestinationSlackResult',
    'AwaitableGetEnDestinationSlackResult',
    'get_en_destination_slack',
    'get_en_destination_slack_output',
]

@pulumi.output_type
class GetEnDestinationSlackResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationSlackConfigResult']:
...
class AwaitableGetEnDestinationSlackResult(GetEnDestinationSlackResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationSlackResult(
...
def get_en_destination_slack(destination_id: Optional[_builtins.str] = None,
                             instance_guid: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationSlackResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationSlack:getEnDestinationSlack', __args__, opts=opts, typ=GetEnDestinationSlackResult).value

    return AwaitableGetEnDestinationSlackResult(
...
def get_en_destination_slack_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                    instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationSlackResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationSlack:getEnDestinationSlack', __args__, opts=opts, typ=GetEnDestinationSlackResult)
    return __ret__.apply(lambda __response__: GetEnDestinationSlackResult(
