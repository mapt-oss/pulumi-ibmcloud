...
__all__ = [
    'GetCdToolchainToolSecuritycomplianceResult',
    'AwaitableGetCdToolchainToolSecuritycomplianceResult',
    'get_cd_toolchain_tool_securitycompliance',
    'get_cd_toolchain_tool_securitycompliance_output',
]

@pulumi.output_type
class GetCdToolchainToolSecuritycomplianceResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolSecuritycomplianceParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolSecuritycomplianceReferentResult']:
...
class AwaitableGetCdToolchainToolSecuritycomplianceResult(GetCdToolchainToolSecuritycomplianceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolSecuritycomplianceResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_securitycompliance(tool_id: Optional[_builtins.str] = None,
                                             toolchain_id: Optional[_builtins.str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolSecuritycomplianceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolSecuritycompliance:getCdToolchainToolSecuritycompliance', __args__, opts=opts, typ=GetCdToolchainToolSecuritycomplianceResult).value

    return AwaitableGetCdToolchainToolSecuritycomplianceResult(
...
def get_cd_toolchain_tool_securitycompliance_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolSecuritycomplianceResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolSecuritycompliance:getCdToolchainToolSecuritycompliance', __args__, opts=opts, typ=GetCdToolchainToolSecuritycomplianceResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolSecuritycomplianceResult(
