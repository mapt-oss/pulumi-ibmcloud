...
__all__ = [
    'GetEnPagerdutyTemplateResult',
    'AwaitableGetEnPagerdutyTemplateResult',
    'get_en_pagerduty_template',
    'get_en_pagerduty_template_output',
]

@pulumi.output_type
class GetEnPagerdutyTemplateResult:
    """
...
class AwaitableGetEnPagerdutyTemplateResult(GetEnPagerdutyTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnPagerdutyTemplateResult(
...
def get_en_pagerduty_template(instance_guid: Optional[_builtins.str] = None,
                              template_id: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnPagerdutyTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnPagerdutyTemplate:getEnPagerdutyTemplate', __args__, opts=opts, typ=GetEnPagerdutyTemplateResult).value

    return AwaitableGetEnPagerdutyTemplateResult(
...
def get_en_pagerduty_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                     template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnPagerdutyTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnPagerdutyTemplate:getEnPagerdutyTemplate', __args__, opts=opts, typ=GetEnPagerdutyTemplateResult)
    return __ret__.apply(lambda __response__: GetEnPagerdutyTemplateResult(
