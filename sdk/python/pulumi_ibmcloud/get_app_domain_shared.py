...
def get_app_domain_shared(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getAppDomainShared:getAppDomainShared', __args__, opts=opts, typ=GetAppDomainSharedResult).value

    return AwaitableGetAppDomainSharedResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'))
def get_app_domain_shared_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getAppDomainShared:getAppDomainShared', __args__, opts=opts, typ=GetAppDomainSharedResult)
