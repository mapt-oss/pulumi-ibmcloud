...
__all__ = [
    'GetEnDestinationAndroidResult',
    'AwaitableGetEnDestinationAndroidResult',
    'get_en_destination_android',
    'get_en_destination_android_output',
]

@pulumi.output_type
class GetEnDestinationAndroidResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationAndroidConfigResult']:
...
class AwaitableGetEnDestinationAndroidResult(GetEnDestinationAndroidResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationAndroidResult(
...
def get_en_destination_android(destination_id: Optional[_builtins.str] = None,
                               instance_guid: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationAndroidResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationAndroid:getEnDestinationAndroid', __args__, opts=opts, typ=GetEnDestinationAndroidResult).value

    return AwaitableGetEnDestinationAndroidResult(
...
def get_en_destination_android_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationAndroidResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationAndroid:getEnDestinationAndroid', __args__, opts=opts, typ=GetEnDestinationAndroidResult)
    return __ret__.apply(lambda __response__: GetEnDestinationAndroidResult(
