...
__all__ = [
    'GetEnSubscriptionsResult',
    'AwaitableGetEnSubscriptionsResult',
    'get_en_subscriptions',
    'get_en_subscriptions_output',
]

@pulumi.output_type
class GetEnSubscriptionsResult:
    """
    A collection of values returned by getEnSubscriptions.
    """
    def __init__(__self__, id=None, instance_guid=None, search_key=None, subscriptions=None, total_count=None):
    ...
    @_builtins.property
    @pulumi.getter
    def subscriptions(self) -> Sequence['outputs.GetEnSubscriptionsSubscriptionResult']:
...
class AwaitableGetEnSubscriptionsResult(GetEnSubscriptionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnSubscriptionsResult(
            id=self.id,
...
def get_en_subscriptions(instance_guid: Optional[_builtins.str] = None,
                         search_key: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnSubscriptionsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnSubscriptions:getEnSubscriptions', __args__, opts=opts, typ=GetEnSubscriptionsResult).value

    return AwaitableGetEnSubscriptionsResult(
...
def get_en_subscriptions_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                search_key: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnSubscriptionsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnSubscriptions:getEnSubscriptions', __args__, opts=opts, typ=GetEnSubscriptionsResult)
    return __ret__.apply(lambda __response__: GetEnSubscriptionsResult(
