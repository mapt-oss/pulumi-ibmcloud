...
class _IsImageState:
    def __init__(__self__, *,
        ...
        if tags is not None:
            pulumi.set(__self__, "tags", tags)
        if user_data_format is not None:
...
class IsImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IsImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IsImageArgs.__new__(IsImageArgs)
    ...
    def get(resource_name: str,
        ...
        __props__ = _IsImageState.__new__(_IsImageState)
    ...
    @_builtins.property
    @pulumi.getter(name="allowedUse")
    def allowed_use(self) -> pulumi.Output['outputs.IsImageAllowedUse']:
        """
        The usage constraints to match against the requested instance or bare metal server properties to determine compatibility.
        """
        return pulumi.get(self, "allowed_use")
    ...
    @_builtins.property
    @pulumi.getter(name="encryptedDataKey")
    def encrypted_data_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A base64-encoded, encrypted representation of the key that was used to encrypt the data for this image
        """
        return pulumi.get(self, "encrypted_data_key")
    ...
    @_builtins.property
    @pulumi.getter
    def obsolete(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Set to obsolete. You can set an image to `obsolete` as a warning to transition away from soon-to-be deleted images. You can't use obsolete images to provision resources.
        """
        return pulumi.get(self, "obsolete")
    ...
    @_builtins.property
    @pulumi.getter(name="userDataFormat")
    def user_data_format(self) -> pulumi.Output[_builtins.str]:
        """
        The user data format for this image
        """
        return pulumi.get(self, "user_data_format")
