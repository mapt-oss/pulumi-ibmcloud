...
class _IamTrustedProfileTemplateAssignmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IamTrustedProfileTemplateAssignmentResourceArgs']]] resources: Status breakdown per target account of IAM resources created or errors encountered in attempting to create those IAM resources. IAM resources are only included in the response providing the assignment is not in progress. IAM resources are also only included when getting a single assignment, and excluded by list APIs.
...
@pulumi.type_token("ibmcloud:index/iamTrustedProfileTemplateAssignment:IamTrustedProfileTemplateAssignment")
class IamTrustedProfileTemplateAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IamTrustedProfileTemplateAssignment, __self__).__init__(
            'ibmcloud:index/iamTrustedProfileTemplateAssignment:IamTrustedProfileTemplateAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            target_type: Optional[pulumi.Input[_builtins.str]] = None,
            template_id: Optional[pulumi.Input[_builtins.str]] = None,
            template_version: Optional[pulumi.Input[_builtins.int]] = None) -> 'IamTrustedProfileTemplateAssignment':
        """
        ...
        :param pulumi.Input[_builtins.str] last_modified_at: Assignment modified at.
        :param pulumi.Input[_builtins.str] last_modified_by_id: IAMid of the identity that last modified the assignment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['IamTrustedProfileTemplateAssignmentResourceArgs', 'IamTrustedProfileTemplateAssignmentResourceArgsDict']]]] resources: Status breakdown per target account of IAM resources created or errors encountered in attempting to create those IAM resources. IAM resources are only included in the response providing the assignment is not in progress. IAM resources are also only included when getting a single assignment, and excluded by list APIs.
        :param pulumi.Input[_builtins.str] status: Assignment status.
        :param pulumi.Input[_builtins.str] target: Assignment target.
        :param pulumi.Input[_builtins.str] target_type: Assignment target type.
        :param pulumi.Input[_builtins.str] template_id: Template Id.
