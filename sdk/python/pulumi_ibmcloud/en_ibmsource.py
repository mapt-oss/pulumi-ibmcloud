...
__all__ = ['EnIbmsourceArgs', 'EnIbmsource']

@pulumi.input_type
class EnIbmsourceArgs:
...
@pulumi.type_token("ibmcloud:index/enIbmsource:EnIbmsource")
class EnIbmsource(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a EnIbmsource resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a EnIbmsource resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnIbmsourceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnIbmsourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnIbmsourceArgs.__new__(EnIbmsourceArgs)
        ...
        super(EnIbmsource, __self__).__init__(
            'ibmcloud:index/enIbmsource:EnIbmsource',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
            source_id: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnIbmsource':
        """
        ...
        __props__ = _EnIbmsourceState.__new__(_EnIbmsourceState)

        __props__.__dict__["enabled"] = enabled
        __props__.__dict__["instance_guid"] = instance_guid
        __props__.__dict__["source_id"] = source_id
        __props__.__dict__["updated_at"] = updated_at
        return EnIbmsource(resource_name, opts=opts, __props__=__props__)
