...
class CdToolchainToolJiraArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CdToolchainToolJiraParametersArgs'] parameters: Unique key-value pairs representing parameters to be used to create the tool. A list of parameters for each tool integration can be found in the <a href="https://cloud.ibm.com/docs/ContinuousDelivery?topic=ContinuousDelivery-integrations">Configuring tool integrations page</a>.
...
@pulumi.type_token("ibmcloud:index/cdToolchainToolJira:CdToolchainToolJira")
class CdToolchainToolJira(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(CdToolchainToolJira, __self__).__init__(
            'ibmcloud:index/cdToolchainToolJira:CdToolchainToolJira',
            resource_name,
            __props__,
            opts)
