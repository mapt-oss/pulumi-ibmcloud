...
@pulumi.type_token("ibmcloud:index/isSubnetReservedIpPatch:IsSubnetReservedIpPatch")
class IsSubnetReservedIpPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IsSubnetReservedIpPatch, __self__).__init__(
            'ibmcloud:index/isSubnetReservedIpPatch:IsSubnetReservedIpPatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet: Optional[pulumi.Input[_builtins.str]] = None,
            target: Optional[pulumi.Input[_builtins.str]] = None,
            target_crn: Optional[pulumi.Input[_builtins.str]] = None) -> 'IsSubnetReservedIpPatch':
        """
