...
class GetSmPublicCertificateMetadataResult:
    ...
    """
    def __init__(__self__, alt_names=None, bundle_certs=None, ca=None, common_name=None, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, dns=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, issuance_infos=None, issuer=None, key_algorithm=None, labels=None, locks_total=None, name=None, region=None, retrieved_at=None, rotations=None, secret_group_id=None, secret_id=None, secret_type=None, serial_number=None, signing_algorithm=None, state=None, state_description=None, updated_at=None, validities=None, versions_total=None):
...
def get_sm_public_certificate_metadata(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmPublicCertificateMetadata:getSmPublicCertificateMetadata', __args__, opts=opts, typ=GetSmPublicCertificateMetadataResult).value
...
def get_sm_public_certificate_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmPublicCertificateMetadata:getSmPublicCertificateMetadata', __args__, opts=opts, typ=GetSmPublicCertificateMetadataResult)
