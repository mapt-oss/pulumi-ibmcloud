...
__all__ = [
    'GetEnAppConfigurationTemplateResult',
    'AwaitableGetEnAppConfigurationTemplateResult',
    'get_en_app_configuration_template',
    'get_en_app_configuration_template_output',
]

@pulumi.output_type
class GetEnAppConfigurationTemplateResult:
    """
...
class AwaitableGetEnAppConfigurationTemplateResult(GetEnAppConfigurationTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnAppConfigurationTemplateResult(
...
def get_en_app_configuration_template(instance_guid: Optional[_builtins.str] = None,
                                      template_id: Optional[_builtins.str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnAppConfigurationTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnAppConfigurationTemplate:getEnAppConfigurationTemplate', __args__, opts=opts, typ=GetEnAppConfigurationTemplateResult).value

    return AwaitableGetEnAppConfigurationTemplateResult(
...
def get_en_app_configuration_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                             template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnAppConfigurationTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnAppConfigurationTemplate:getEnAppConfigurationTemplate', __args__, opts=opts, typ=GetEnAppConfigurationTemplateResult)
    return __ret__.apply(lambda __response__: GetEnAppConfigurationTemplateResult(
