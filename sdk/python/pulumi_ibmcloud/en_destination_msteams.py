...
__all__ = ['EnDestinationMsteamsArgs', 'EnDestinationMsteams']

@pulumi.input_type
class EnDestinationMsteamsArgs:
    def __init__(__self__, *,
                 instance_guid: pulumi.Input[_builtins.str],
                 type: pulumi.Input[_builtins.str],
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationMsteamsConfigArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: The type of Destination msteams.
        ...
        :param pulumi.Input['EnDestinationMsteamsConfigArgs'] config: Payload describing a destination configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> Optional[pulumi.Input['EnDestinationMsteamsConfigArgs']]:
        """
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input['EnDestinationMsteamsConfigArgs']]):
...
@pulumi.input_type
class _EnDestinationMsteamsState:
    def __init__(__self__, *,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationMsteamsConfigArgs']] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("ibmcloud:index/enDestinationMsteams:EnDestinationMsteams")
class EnDestinationMsteams(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input[Union['EnDestinationMsteamsConfigArgs', 'EnDestinationMsteamsConfigArgsDict']]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnDestinationMsteams resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] collect_failed_events: Whether to collect the failed event in Cloud Object Storage bucket
        :param pulumi.Input[Union['EnDestinationMsteamsConfigArgs', 'EnDestinationMsteamsConfigArgsDict']] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] description: The Destination description.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] name: The Destintion name.
        :param pulumi.Input[_builtins.str] type: The type of Destination msteams.
    ...
    def __init__(__self__,
        ...
        Create a EnDestinationMsteams resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnDestinationMsteamsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnDestinationMsteamsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnDestinationMsteamsArgs.__new__(EnDestinationMsteamsArgs)
        ...
        super(EnDestinationMsteams, __self__).__init__(
            'ibmcloud:index/enDestinationMsteams:EnDestinationMsteams',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subscription_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnDestinationMsteams':
        """
        ...
        __props__ = _EnDestinationMsteamsState.__new__(_EnDestinationMsteamsState)
        ...
        return EnDestinationMsteams(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output[Optional['outputs.EnDestinationMsteamsConfig']]:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
