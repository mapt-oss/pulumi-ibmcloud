...
__all__ = ['IamActionControlTemplateArgs', 'IamActionControlTemplate']
...
@pulumi.type_token("ibmcloud:index/iamActionControlTemplate:IamActionControlTemplate")
class IamActionControlTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IamActionControlTemplateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IamActionControlTemplateArgs.__new__(IamActionControlTemplateArgs)
            ...
            __props__.__dict__["action_control_template_id"] = None
        ...
        super(IamActionControlTemplate, __self__).__init__(
            'ibmcloud:index/iamActionControlTemplate:IamActionControlTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _IamActionControlTemplateState.__new__(_IamActionControlTemplateState)
        ...
        return IamActionControlTemplate(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="actionControls")
    def action_controls(self) -> pulumi.Output[Optional[Sequence['outputs.IamActionControlTemplateActionControl']]]:
        """
        The action control properties that are created in an action resource when the template is assigned.
        """
        return pulumi.get(self, "action_controls")
