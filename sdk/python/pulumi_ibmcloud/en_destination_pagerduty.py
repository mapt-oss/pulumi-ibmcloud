...
__all__ = ['EnDestinationPagerdutyArgs', 'EnDestinationPagerduty']

@pulumi.input_type
class EnDestinationPagerdutyArgs:
    def __init__(__self__, *,
                 config: pulumi.Input['EnDestinationPagerdutyConfigArgs'],
        ...
        :param pulumi.Input['EnDestinationPagerdutyConfigArgs'] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] type: The type of Destination type pagerduty.
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Input['EnDestinationPagerdutyConfigArgs']:
        """
    ...
    @config.setter
    def config(self, value: pulumi.Input['EnDestinationPagerdutyConfigArgs']):
...
@pulumi.input_type
class _EnDestinationPagerdutyState:
    def __init__(__self__, *,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationPagerdutyConfigArgs']] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> Optional[pulumi.Input['EnDestinationPagerdutyConfigArgs']]:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input['EnDestinationPagerdutyConfigArgs']]):
        pulumi.set(self, "config", value)
...
@pulumi.type_token("ibmcloud:index/enDestinationPagerduty:EnDestinationPagerduty")
class EnDestinationPagerduty(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input[Union['EnDestinationPagerdutyConfigArgs', 'EnDestinationPagerdutyConfigArgsDict']]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnDestinationPagerduty resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] collect_failed_events: Whether to collect the failed event in Cloud Object Storage bucket
        :param pulumi.Input[Union['EnDestinationPagerdutyConfigArgs', 'EnDestinationPagerdutyConfigArgsDict']] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] description: The Destination description.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] name: The Destintion name.
        :param pulumi.Input[_builtins.str] type: The type of Destination type pagerduty.
    ...
    def __init__(__self__,
        ...
        Create a EnDestinationPagerduty resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnDestinationPagerdutyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnDestinationPagerdutyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnDestinationPagerdutyArgs.__new__(EnDestinationPagerdutyArgs)
        ...
        super(EnDestinationPagerduty, __self__).__init__(
            'ibmcloud:index/enDestinationPagerduty:EnDestinationPagerduty',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subscription_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnDestinationPagerduty':
        """
        Get an existing EnDestinationPagerduty resource's state with the given name, id, and optional extra
        ...
        __props__ = _EnDestinationPagerdutyState.__new__(_EnDestinationPagerdutyState)
        ...
        return EnDestinationPagerduty(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output['outputs.EnDestinationPagerdutyConfig']:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
