...
__all__ = ['EnSlackTemplateArgs', 'EnSlackTemplate']

@pulumi.input_type
class EnSlackTemplateArgs:
    def __init__(__self__, *,
                 instance_guid: pulumi.Input[_builtins.str],
                 params: pulumi.Input['EnSlackTemplateParamsArgs'],
    ...
    @_builtins.property
    @pulumi.getter
    def params(self) -> pulumi.Input['EnSlackTemplateParamsArgs']:
        return pulumi.get(self, "params")

    @params.setter
    def params(self, value: pulumi.Input['EnSlackTemplateParamsArgs']):
...
@pulumi.input_type
class _EnSlackTemplateState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 params: Optional[pulumi.Input['EnSlackTemplateParamsArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def params(self) -> Optional[pulumi.Input['EnSlackTemplateParamsArgs']]:
        return pulumi.get(self, "params")

    @params.setter
    def params(self, value: Optional[pulumi.Input['EnSlackTemplateParamsArgs']]):
        pulumi.set(self, "params", value)
...
@pulumi.type_token("ibmcloud:index/enSlackTemplate:EnSlackTemplate")
class EnSlackTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 params: Optional[pulumi.Input[Union['EnSlackTemplateParamsArgs', 'EnSlackTemplateParamsArgsDict']]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnSlackTemplate resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a EnSlackTemplate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnSlackTemplateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnSlackTemplateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnSlackTemplateArgs.__new__(EnSlackTemplateArgs)
        ...
        super(EnSlackTemplate, __self__).__init__(
            'ibmcloud:index/enSlackTemplate:EnSlackTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            template_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnSlackTemplate':
        """
        Get an existing EnSlackTemplate resource's state with the given name, id, and optional extra
        ...
        __props__ = _EnSlackTemplateState.__new__(_EnSlackTemplateState)
        ...
        return EnSlackTemplate(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def params(self) -> pulumi.Output['outputs.EnSlackTemplateParams']:
        return pulumi.get(self, "params")
