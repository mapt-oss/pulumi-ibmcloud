...
__all__ = [
    'GetCdToolchainToolSlackResult',
    'AwaitableGetCdToolchainToolSlackResult',
    'get_cd_toolchain_tool_slack',
    'get_cd_toolchain_tool_slack_output',
]

@pulumi.output_type
class GetCdToolchainToolSlackResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolSlackParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolSlackReferentResult']:
...
class AwaitableGetCdToolchainToolSlackResult(GetCdToolchainToolSlackResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolSlackResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_slack(tool_id: Optional[_builtins.str] = None,
                                toolchain_id: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolSlackResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolSlack:getCdToolchainToolSlack', __args__, opts=opts, typ=GetCdToolchainToolSlackResult).value

    return AwaitableGetCdToolchainToolSlackResult(
...
def get_cd_toolchain_tool_slack_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolSlackResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolSlack:getCdToolchainToolSlack', __args__, opts=opts, typ=GetCdToolchainToolSlackResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolSlackResult(
