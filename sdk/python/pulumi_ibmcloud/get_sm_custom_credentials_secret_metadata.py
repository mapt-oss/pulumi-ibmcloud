...
class GetSmCustomCredentialsSecretMetadataResult:
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetSmCustomCredentialsSecretMetadataParameterResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def rotations(self) -> Sequence['outputs.GetSmCustomCredentialsSecretMetadataRotationResult']:
...
class AwaitableGetSmCustomCredentialsSecretMetadataResult(GetSmCustomCredentialsSecretMetadataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmCustomCredentialsSecretMetadataResult(
...
def get_sm_custom_credentials_secret_metadata(endpoint_type: Optional[_builtins.str] = None,
                                              instance_id: Optional[_builtins.str] = None,
                                              name: Optional[_builtins.str] = None,
                                              region: Optional[_builtins.str] = None,
                                              secret_group_name: Optional[_builtins.str] = None,
                                              secret_id: Optional[_builtins.str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmCustomCredentialsSecretMetadataResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmCustomCredentialsSecretMetadata:getSmCustomCredentialsSecretMetadata', __args__, opts=opts, typ=GetSmCustomCredentialsSecretMetadataResult).value

    return AwaitableGetSmCustomCredentialsSecretMetadataResult(
...
def get_sm_custom_credentials_secret_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     ...
                                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmCustomCredentialsSecretMetadataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmCustomCredentialsSecretMetadata:getSmCustomCredentialsSecretMetadata', __args__, opts=opts, typ=GetSmCustomCredentialsSecretMetadataResult)
    return __ret__.apply(lambda __response__: GetSmCustomCredentialsSecretMetadataResult(
