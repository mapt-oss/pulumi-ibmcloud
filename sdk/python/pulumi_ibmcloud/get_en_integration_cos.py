...
def get_en_integration_cos(instance_guid: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnIntegrationCos:getEnIntegrationCos', __args__, opts=opts, typ=GetEnIntegrationCosResult).value
...
def get_en_integration_cos_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnIntegrationCos:getEnIntegrationCos', __args__, opts=opts, typ=GetEnIntegrationCosResult)
