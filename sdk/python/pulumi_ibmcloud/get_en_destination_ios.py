...
def get_en_destination_ios(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationIos:getEnDestinationIos', __args__, opts=opts, typ=GetEnDestinationIosResult).value
...
def get_en_destination_ios_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationIos:getEnDestinationIos', __args__, opts=opts, typ=GetEnDestinationIosResult)
