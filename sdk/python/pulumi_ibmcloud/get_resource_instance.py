...
__all__ = [
    'GetResourceInstanceResult',
    'AwaitableGetResourceInstanceResult',
    'get_resource_instance',
    'get_resource_instance_output',
]

@pulumi.output_type
class GetResourceInstanceResult:
    """
...
class AwaitableGetResourceInstanceResult(GetResourceInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetResourceInstanceResult(
            crn=self.crn,
...
def get_resource_instance(identifier: Optional[_builtins.str] = None,
                          location: Optional[_builtins.str] = None,
                          name: Optional[_builtins.str] = None,
                          resource_group_id: Optional[_builtins.str] = None,
                          service: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceInstanceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getResourceInstance:getResourceInstance', __args__, opts=opts, typ=GetResourceInstanceResult).value

    return AwaitableGetResourceInstanceResult(
...
def get_resource_instance_output(identifier: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getResourceInstance:getResourceInstance', __args__, opts=opts, typ=GetResourceInstanceResult)
    return __ret__.apply(lambda __response__: GetResourceInstanceResult(
