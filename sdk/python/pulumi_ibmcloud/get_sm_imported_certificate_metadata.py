...
__all__ = [
    'GetSmImportedCertificateMetadataResult',
    'AwaitableGetSmImportedCertificateMetadataResult',
    'get_sm_imported_certificate_metadata',
    'get_sm_imported_certificate_metadata_output',
]

@pulumi.output_type
class GetSmImportedCertificateMetadataResult:
    """
    A collection of values returned by getSmImportedCertificateMetadata.
    """
    def __init__(__self__, common_name=None, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, intermediate_included=None, issuer=None, key_algorithm=None, labels=None, locks_total=None, managed_csrs=None, name=None, private_key_included=None, region=None, retrieved_at=None, secret_group_id=None, secret_id=None, secret_type=None, serial_number=None, signing_algorithm=None, state=None, state_description=None, updated_at=None, validities=None, versions_total=None):
    ...
    def managed_csrs(self) -> Sequence['outputs.GetSmImportedCertificateMetadataManagedCsrResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def validities(self) -> Sequence['outputs.GetSmImportedCertificateMetadataValidityResult']:
...
class AwaitableGetSmImportedCertificateMetadataResult(GetSmImportedCertificateMetadataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmImportedCertificateMetadataResult(
...
def get_sm_imported_certificate_metadata(endpoint_type: Optional[_builtins.str] = None,
                                         instance_id: Optional[_builtins.str] = None,
                                         region: Optional[_builtins.str] = None,
                                         secret_id: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmImportedCertificateMetadataResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmImportedCertificateMetadata:getSmImportedCertificateMetadata', __args__, opts=opts, typ=GetSmImportedCertificateMetadataResult).value

    return AwaitableGetSmImportedCertificateMetadataResult(
...
def get_sm_imported_certificate_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                secret_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmImportedCertificateMetadataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmImportedCertificateMetadata:getSmImportedCertificateMetadata', __args__, opts=opts, typ=GetSmImportedCertificateMetadataResult)
    return __ret__.apply(lambda __response__: GetSmImportedCertificateMetadataResult(
