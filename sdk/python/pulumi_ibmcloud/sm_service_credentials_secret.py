...
__all__ = ['SmServiceCredentialsSecretArgs', 'SmServiceCredentialsSecret']

@pulumi.input_type
class SmServiceCredentialsSecretArgs:
    def __init__(__self__, *,
                 instance_id: pulumi.Input[_builtins.str],
                 source_service: pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs'],
                 ...
                 rotation: Optional[pulumi.Input['SmServiceCredentialsSecretRotationArgs']] = None,
        ...
        :param pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs'] source_service: The properties required for creating the service credentials for the specified source service instance.
        ...
        :param pulumi.Input['SmServiceCredentialsSecretRotationArgs'] rotation: Determines whether Secrets Manager rotates your secrets automatically.
    ...
    def source_service(self) -> pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs']:
        """
    ...
    def source_service(self, value: pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs']):
    ...
    @_builtins.property
    @pulumi.getter
    def rotation(self) -> Optional[pulumi.Input['SmServiceCredentialsSecretRotationArgs']]:
        """
    ...
    @rotation.setter
    def rotation(self, value: Optional[pulumi.Input['SmServiceCredentialsSecretRotationArgs']]):
...
@pulumi.input_type
class _SmServiceCredentialsSecretState:
    def __init__(__self__, *,
                 ...
                 source_service: Optional[pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] credentials: The properties of the service credentials secret payload.
    ...
    @_builtins.property
    @pulumi.getter(name="sourceService")
    def source_service(self) -> Optional[pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs']]:
        """
        The properties required for creating the service credentials for the specified source service instance.
        """
        return pulumi.get(self, "source_service")
    ...
    @source_service.setter
    def source_service(self, value: Optional[pulumi.Input['SmServiceCredentialsSecretSourceServiceArgs']]):
        pulumi.set(self, "source_service", value)
...
@pulumi.type_token("ibmcloud:index/smServiceCredentialsSecret:SmServiceCredentialsSecret")
class SmServiceCredentialsSecret(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 rotation: Optional[pulumi.Input[Union['SmServiceCredentialsSecretRotationArgs', 'SmServiceCredentialsSecretRotationArgsDict']]] = None,
                 secret_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 source_service: Optional[pulumi.Input[Union['SmServiceCredentialsSecretSourceServiceArgs', 'SmServiceCredentialsSecretSourceServiceArgsDict']]] = None,
                 ttl: Optional[pulumi.Input[_builtins.str]] = None,
                 version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        Create a SmServiceCredentialsSecret resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[_builtins.str] name: A human-readable name to assign to your secret.To protect your privacy, do not use personal data, such as your name or location, as a name for your secret.
        :param pulumi.Input[_builtins.str] region: The region of the Secrets Manager instance.
        :param pulumi.Input[Union['SmServiceCredentialsSecretRotationArgs', 'SmServiceCredentialsSecretRotationArgsDict']] rotation: Determines whether Secrets Manager rotates your secrets automatically.
        :param pulumi.Input[_builtins.str] secret_group_id: A UUID identifier, or `default` secret group.
        :param pulumi.Input[Union['SmServiceCredentialsSecretSourceServiceArgs', 'SmServiceCredentialsSecretSourceServiceArgsDict']] source_service: The properties required for creating the service credentials for the specified source service instance.
        :param pulumi.Input[_builtins.str] ttl: The time-to-live (TTL) or lease duration to assign to generated credentials.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] version_custom_metadata: The secret version metadata that a user can customize.
        """
        ...
    ...
    def __init__(__self__,
        ...
        Create a SmServiceCredentialsSecret resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SmServiceCredentialsSecretArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmServiceCredentialsSecretArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmServiceCredentialsSecretArgs.__new__(SmServiceCredentialsSecretArgs)
            ...
            if source_service is None and not opts.urn:
                raise TypeError("Missing required property 'source_service'")
            __props__.__dict__["source_service"] = source_service
        ...
        super(SmServiceCredentialsSecret, __self__).__init__(
            'ibmcloud:index/smServiceCredentialsSecret:SmServiceCredentialsSecret',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            versions_total: Optional[pulumi.Input[_builtins.int]] = None) -> 'SmServiceCredentialsSecret':
        """
        ...
        __props__ = _SmServiceCredentialsSecretState.__new__(_SmServiceCredentialsSecretState)
        ...
        return SmServiceCredentialsSecret(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def rotation(self) -> pulumi.Output['outputs.SmServiceCredentialsSecretRotation']:
        """
        Determines whether Secrets Manager rotates your secrets automatically.
        """
        return pulumi.get(self, "rotation")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceService")
    def source_service(self) -> pulumi.Output['outputs.SmServiceCredentialsSecretSourceService']:
        """
        The properties required for creating the service credentials for the specified source service instance.
        """
        return pulumi.get(self, "source_service")
