...
__all__ = [
    'GetEnDestinationChromeResult',
    'AwaitableGetEnDestinationChromeResult',
    'get_en_destination_chrome',
    'get_en_destination_chrome_output',
]

@pulumi.output_type
class GetEnDestinationChromeResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationChromeConfigResult']:
...
class AwaitableGetEnDestinationChromeResult(GetEnDestinationChromeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationChromeResult(
...
def get_en_destination_chrome(destination_id: Optional[_builtins.str] = None,
                              instance_guid: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationChromeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationChrome:getEnDestinationChrome', __args__, opts=opts, typ=GetEnDestinationChromeResult).value

    return AwaitableGetEnDestinationChromeResult(
...
def get_en_destination_chrome_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationChromeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationChrome:getEnDestinationChrome', __args__, opts=opts, typ=GetEnDestinationChromeResult)
    return __ret__.apply(lambda __response__: GetEnDestinationChromeResult(
