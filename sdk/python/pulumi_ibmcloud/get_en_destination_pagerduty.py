...
__all__ = [
    'GetEnDestinationPagerdutyResult',
    'AwaitableGetEnDestinationPagerdutyResult',
    'get_en_destination_pagerduty',
    'get_en_destination_pagerduty_output',
]

@pulumi.output_type
class GetEnDestinationPagerdutyResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationPagerdutyConfigResult']:
...
class AwaitableGetEnDestinationPagerdutyResult(GetEnDestinationPagerdutyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationPagerdutyResult(
...
def get_en_destination_pagerduty(destination_id: Optional[_builtins.str] = None,
                                 instance_guid: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationPagerdutyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationPagerduty:getEnDestinationPagerduty', __args__, opts=opts, typ=GetEnDestinationPagerdutyResult).value

    return AwaitableGetEnDestinationPagerdutyResult(
...
def get_en_destination_pagerduty_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationPagerdutyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationPagerduty:getEnDestinationPagerduty', __args__, opts=opts, typ=GetEnDestinationPagerdutyResult)
    return __ret__.apply(lambda __response__: GetEnDestinationPagerdutyResult(
