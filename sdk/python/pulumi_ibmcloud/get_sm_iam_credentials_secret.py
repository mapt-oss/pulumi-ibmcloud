...
__all__ = [
    'GetSmIamCredentialsSecretResult',
    'AwaitableGetSmIamCredentialsSecretResult',
    'get_sm_iam_credentials_secret',
    'get_sm_iam_credentials_secret_output',
]

@pulumi.output_type
class GetSmIamCredentialsSecretResult:
    """
    A collection of values returned by getSmIamCredentialsSecret.
    """
    def __init__(__self__, access_groups=None, account_id=None, api_key=None, api_key_id=None, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, next_rotation_date=None, region=None, retrieved_at=None, reuse_api_key=None, rotations=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, service_id=None, service_id_is_static=None, state=None, state_description=None, ttl=None, updated_at=None, versions_total=None):
        ...
        if reuse_api_key and not isinstance(reuse_api_key, bool):
            raise TypeError("Expected argument 'reuse_api_key' to be a bool")
        ...
        if service_id_is_static and not isinstance(service_id_is_static, bool):
            raise TypeError("Expected argument 'service_id_is_static' to be a bool")
    ...
    def reuse_api_key(self) -> _builtins.bool:
        return pulumi.get(self, "reuse_api_key")

    @_builtins.property
    @pulumi.getter
    def rotations(self) -> Sequence['outputs.GetSmIamCredentialsSecretRotationResult']:
    ...
    def service_id_is_static(self) -> _builtins.bool:
...
class AwaitableGetSmIamCredentialsSecretResult(GetSmIamCredentialsSecretResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmIamCredentialsSecretResult(
            ...
            reuse_api_key=self.reuse_api_key,
            ...
            service_id_is_static=self.service_id_is_static,
            state=self.state,
...
def get_sm_iam_credentials_secret(endpoint_type: Optional[_builtins.str] = None,
                                  instance_id: Optional[_builtins.str] = None,
                                  name: Optional[_builtins.str] = None,
                                  region: Optional[_builtins.str] = None,
                                  secret_group_name: Optional[_builtins.str] = None,
                                  secret_id: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmIamCredentialsSecretResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmIamCredentialsSecret:getSmIamCredentialsSecret', __args__, opts=opts, typ=GetSmIamCredentialsSecretResult).value

    return AwaitableGetSmIamCredentialsSecretResult(
        ...
        reuse_api_key=pulumi.get(__ret__, 'reuse_api_key'),
        ...
        service_id_is_static=pulumi.get(__ret__, 'service_id_is_static'),
...
def get_sm_iam_credentials_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmIamCredentialsSecretResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmIamCredentialsSecret:getSmIamCredentialsSecret', __args__, opts=opts, typ=GetSmIamCredentialsSecretResult)
    return __ret__.apply(lambda __response__: GetSmIamCredentialsSecretResult(
        ...
        reuse_api_key=pulumi.get(__response__, 'reuse_api_key'),
        ...
        service_id_is_static=pulumi.get(__response__, 'service_id_is_static'),
