...
def get_container_vpc_cluster_worker_pool(cluster: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getContainerVpcClusterWorkerPool:getContainerVpcClusterWorkerPool', __args__, opts=opts, typ=GetContainerVpcClusterWorkerPoolResult).value
...
def get_container_vpc_cluster_worker_pool_output(cluster: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getContainerVpcClusterWorkerPool:getContainerVpcClusterWorkerPool', __args__, opts=opts, typ=GetContainerVpcClusterWorkerPoolResult)
