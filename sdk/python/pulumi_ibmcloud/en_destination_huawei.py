...
__all__ = ['EnDestinationHuaweiArgs', 'EnDestinationHuawei']

@pulumi.input_type
class EnDestinationHuaweiArgs:
    def __init__(__self__, *,
                 instance_guid: pulumi.Input[_builtins.str],
                 type: pulumi.Input[_builtins.str],
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationHuaweiConfigArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: The type of Destination push_huawei.
        ...
        :param pulumi.Input['EnDestinationHuaweiConfigArgs'] config: Payload describing a destination configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> Optional[pulumi.Input['EnDestinationHuaweiConfigArgs']]:
        """
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input['EnDestinationHuaweiConfigArgs']]):
...
@pulumi.input_type
class _EnDestinationHuaweiState:
    def __init__(__self__, *,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationHuaweiConfigArgs']] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("ibmcloud:index/enDestinationHuawei:EnDestinationHuawei")
class EnDestinationHuawei(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input[Union['EnDestinationHuaweiConfigArgs', 'EnDestinationHuaweiConfigArgsDict']]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnDestinationHuawei resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] collect_failed_events: Whether to collect the failed event in Cloud Object Storage bucket
        :param pulumi.Input[Union['EnDestinationHuaweiConfigArgs', 'EnDestinationHuaweiConfigArgsDict']] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] description: The Destination description.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] name: The Destintion name.
        :param pulumi.Input[_builtins.str] type: The type of Destination push_huawei.
    ...
    def __init__(__self__,
        ...
        Create a EnDestinationHuawei resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnDestinationHuaweiArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnDestinationHuaweiArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnDestinationHuaweiArgs.__new__(EnDestinationHuaweiArgs)
        ...
        super(EnDestinationHuawei, __self__).__init__(
            'ibmcloud:index/enDestinationHuawei:EnDestinationHuawei',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subscription_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnDestinationHuawei':
        """
        ...
        __props__ = _EnDestinationHuaweiState.__new__(_EnDestinationHuaweiState)
        ...
        return EnDestinationHuawei(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output[Optional['outputs.EnDestinationHuaweiConfig']]:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
