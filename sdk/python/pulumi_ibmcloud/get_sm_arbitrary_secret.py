...
__all__ = [
    'GetSmArbitrarySecretResult',
    'AwaitableGetSmArbitrarySecretResult',
    'get_sm_arbitrary_secret',
    'get_sm_arbitrary_secret_output',
]

@pulumi.output_type
class GetSmArbitrarySecretResult:
    """
    A collection of values returned by getSmArbitrarySecret.
    """
    def __init__(__self__, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, payload=None, region=None, retrieved_at=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, state=None, state_description=None, updated_at=None, versions_total=None):
...
class AwaitableGetSmArbitrarySecretResult(GetSmArbitrarySecretResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmArbitrarySecretResult(
...
def get_sm_arbitrary_secret(endpoint_type: Optional[_builtins.str] = None,
                            instance_id: Optional[_builtins.str] = None,
                            name: Optional[_builtins.str] = None,
                            region: Optional[_builtins.str] = None,
                            secret_group_name: Optional[_builtins.str] = None,
                            secret_id: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmArbitrarySecretResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmArbitrarySecret:getSmArbitrarySecret', __args__, opts=opts, typ=GetSmArbitrarySecretResult).value

    return AwaitableGetSmArbitrarySecretResult(
...
def get_sm_arbitrary_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmArbitrarySecretResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmArbitrarySecret:getSmArbitrarySecret', __args__, opts=opts, typ=GetSmArbitrarySecretResult)
    return __ret__.apply(lambda __response__: GetSmArbitrarySecretResult(
