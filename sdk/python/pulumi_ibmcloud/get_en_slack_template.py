...
__all__ = [
    'GetEnSlackTemplateResult',
    'AwaitableGetEnSlackTemplateResult',
    'get_en_slack_template',
    'get_en_slack_template_output',
]

@pulumi.output_type
class GetEnSlackTemplateResult:
    """
...
class AwaitableGetEnSlackTemplateResult(GetEnSlackTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnSlackTemplateResult(
...
def get_en_slack_template(instance_guid: Optional[_builtins.str] = None,
                          template_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnSlackTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnSlackTemplate:getEnSlackTemplate', __args__, opts=opts, typ=GetEnSlackTemplateResult).value

    return AwaitableGetEnSlackTemplateResult(
...
def get_en_slack_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                 template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnSlackTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnSlackTemplate:getEnSlackTemplate', __args__, opts=opts, typ=GetEnSlackTemplateResult)
    return __ret__.apply(lambda __response__: GetEnSlackTemplateResult(
