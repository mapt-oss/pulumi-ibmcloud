...
__all__ = [
    'GetCdToolchainToolJiraResult',
    'AwaitableGetCdToolchainToolJiraResult',
    'get_cd_toolchain_tool_jira',
    'get_cd_toolchain_tool_jira_output',
]

@pulumi.output_type
class GetCdToolchainToolJiraResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolJiraParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolJiraReferentResult']:
...
class AwaitableGetCdToolchainToolJiraResult(GetCdToolchainToolJiraResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolJiraResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_jira(tool_id: Optional[_builtins.str] = None,
                               toolchain_id: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolJiraResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolJira:getCdToolchainToolJira', __args__, opts=opts, typ=GetCdToolchainToolJiraResult).value

    return AwaitableGetCdToolchainToolJiraResult(
...
def get_cd_toolchain_tool_jira_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolJiraResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolJira:getCdToolchainToolJira', __args__, opts=opts, typ=GetCdToolchainToolJiraResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolJiraResult(
