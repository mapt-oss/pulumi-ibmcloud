...
__all__ = [
    'GetPiVolumeGroupResult',
    'AwaitableGetPiVolumeGroupResult',
    'get_pi_volume_group',
    'get_pi_volume_group_output',
]

@pulumi.output_type
class GetPiVolumeGroupResult:
    """
    A collection of values returned by getPiVolumeGroup.
    """
    def __init__(__self__, auxiliary=None, consistency_group_name=None, id=None, pi_cloud_instance_id=None, pi_volume_group_id=None, replication_sites=None, replication_status=None, status=None, status_description_errors=None, storage_pool=None, volume_group_name=None):
    ...
    def status_description_errors(self) -> Sequence['outputs.GetPiVolumeGroupStatusDescriptionErrorResult']:
...
class AwaitableGetPiVolumeGroupResult(GetPiVolumeGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPiVolumeGroupResult(
...
def get_pi_volume_group(pi_cloud_instance_id: Optional[_builtins.str] = None,
                        pi_volume_group_id: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPiVolumeGroupResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getPiVolumeGroup:getPiVolumeGroup', __args__, opts=opts, typ=GetPiVolumeGroupResult).value

    return AwaitableGetPiVolumeGroupResult(
...
def get_pi_volume_group_output(pi_cloud_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                               pi_volume_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPiVolumeGroupResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getPiVolumeGroup:getPiVolumeGroup', __args__, opts=opts, typ=GetPiVolumeGroupResult)
    return __ret__.apply(lambda __response__: GetPiVolumeGroupResult(
