...
__all__ = [
    'GetCdToolchainToolCustomResult',
    'AwaitableGetCdToolchainToolCustomResult',
    'get_cd_toolchain_tool_custom',
    'get_cd_toolchain_tool_custom_output',
]

@pulumi.output_type
class GetCdToolchainToolCustomResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolCustomParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolCustomReferentResult']:
...
class AwaitableGetCdToolchainToolCustomResult(GetCdToolchainToolCustomResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolCustomResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_custom(tool_id: Optional[_builtins.str] = None,
                                 toolchain_id: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolCustomResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolCustom:getCdToolchainToolCustom', __args__, opts=opts, typ=GetCdToolchainToolCustomResult).value

    return AwaitableGetCdToolchainToolCustomResult(
...
def get_cd_toolchain_tool_custom_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolCustomResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolCustom:getCdToolchainToolCustom', __args__, opts=opts, typ=GetCdToolchainToolCustomResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolCustomResult(
