...
__all__ = [
    'GetEnDestinationEventStreamsResult',
    'AwaitableGetEnDestinationEventStreamsResult',
    'get_en_destination_event_streams',
    'get_en_destination_event_streams_output',
]

@pulumi.output_type
class GetEnDestinationEventStreamsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationEventStreamsConfigResult']:
...
class AwaitableGetEnDestinationEventStreamsResult(GetEnDestinationEventStreamsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationEventStreamsResult(
...
def get_en_destination_event_streams(destination_id: Optional[_builtins.str] = None,
                                     instance_guid: Optional[_builtins.str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationEventStreamsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationEventStreams:getEnDestinationEventStreams', __args__, opts=opts, typ=GetEnDestinationEventStreamsResult).value

    return AwaitableGetEnDestinationEventStreamsResult(
...
def get_en_destination_event_streams_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationEventStreamsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationEventStreams:getEnDestinationEventStreams', __args__, opts=opts, typ=GetEnDestinationEventStreamsResult)
    return __ret__.apply(lambda __response__: GetEnDestinationEventStreamsResult(
