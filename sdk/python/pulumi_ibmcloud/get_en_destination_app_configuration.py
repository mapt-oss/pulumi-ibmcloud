...
__all__ = [
    'GetEnDestinationAppConfigurationResult',
    'AwaitableGetEnDestinationAppConfigurationResult',
    'get_en_destination_app_configuration',
    'get_en_destination_app_configuration_output',
]

@pulumi.output_type
class GetEnDestinationAppConfigurationResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationAppConfigurationConfigResult']:
...
class AwaitableGetEnDestinationAppConfigurationResult(GetEnDestinationAppConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationAppConfigurationResult(
...
def get_en_destination_app_configuration(destination_id: Optional[_builtins.str] = None,
                                         instance_guid: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationAppConfigurationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationAppConfiguration:getEnDestinationAppConfiguration', __args__, opts=opts, typ=GetEnDestinationAppConfigurationResult).value

    return AwaitableGetEnDestinationAppConfigurationResult(
...
def get_en_destination_app_configuration_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationAppConfigurationResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationAppConfiguration:getEnDestinationAppConfiguration', __args__, opts=opts, typ=GetEnDestinationAppConfigurationResult)
    return __ret__.apply(lambda __response__: GetEnDestinationAppConfigurationResult(
