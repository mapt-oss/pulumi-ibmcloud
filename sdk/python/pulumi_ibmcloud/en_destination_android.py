...
__all__ = ['EnDestinationAndroidArgs', 'EnDestinationAndroid']

@pulumi.input_type
class EnDestinationAndroidArgs:
    def __init__(__self__, *,
                 instance_guid: pulumi.Input[_builtins.str],
                 type: pulumi.Input[_builtins.str],
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationAndroidConfigArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: The type of Destination push_android.
        ...
        :param pulumi.Input['EnDestinationAndroidConfigArgs'] config: Payload describing a destination configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> Optional[pulumi.Input['EnDestinationAndroidConfigArgs']]:
        """
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input['EnDestinationAndroidConfigArgs']]):
...
@pulumi.input_type
class _EnDestinationAndroidState:
    def __init__(__self__, *,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input['EnDestinationAndroidConfigArgs']] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("ibmcloud:index/enDestinationAndroid:EnDestinationAndroid")
class EnDestinationAndroid(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 collect_failed_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 config: Optional[pulumi.Input[Union['EnDestinationAndroidConfigArgs', 'EnDestinationAndroidConfigArgsDict']]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        Create a EnDestinationAndroid resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] collect_failed_events: Whether to collect the failed event in Cloud Object Storage bucket
        :param pulumi.Input[Union['EnDestinationAndroidConfigArgs', 'EnDestinationAndroidConfigArgsDict']] config: Payload describing a destination configuration.
        :param pulumi.Input[_builtins.str] description: The Destination description.
        :param pulumi.Input[_builtins.str] instance_guid: Unique identifier for IBM Cloud Event Notifications instance.
        :param pulumi.Input[_builtins.str] name: The Destintion name.
        :param pulumi.Input[_builtins.str] type: The type of Destination push_android.
    ...
    def __init__(__self__,
        ...
        Create a EnDestinationAndroid resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param EnDestinationAndroidArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnDestinationAndroidArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnDestinationAndroidArgs.__new__(EnDestinationAndroidArgs)
        ...
        super(EnDestinationAndroid, __self__).__init__(
            'ibmcloud:index/enDestinationAndroid:EnDestinationAndroid',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subscription_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'EnDestinationAndroid':
        """
        ...
        __props__ = _EnDestinationAndroidState.__new__(_EnDestinationAndroidState)
        ...
        return EnDestinationAndroid(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def config(self) -> pulumi.Output[Optional['outputs.EnDestinationAndroidConfig']]:
        """
        Payload describing a destination configuration.
        """
        return pulumi.get(self, "config")
