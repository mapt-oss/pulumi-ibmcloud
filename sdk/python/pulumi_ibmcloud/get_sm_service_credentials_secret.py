...
__all__ = [
    'GetSmServiceCredentialsSecretResult',
    'AwaitableGetSmServiceCredentialsSecretResult',
    'get_sm_service_credentials_secret',
    'get_sm_service_credentials_secret_output',
]

@pulumi.output_type
class GetSmServiceCredentialsSecretResult:
    """
    A collection of values returned by getSmServiceCredentialsSecret.
    """
    def __init__(__self__, created_at=None, created_by=None, credentials=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, next_rotation_date=None, region=None, retrieved_at=None, rotations=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, source_services=None, state=None, state_description=None, ttl=None, updated_at=None, versions_total=None):
    ...
    @_builtins.property
    @pulumi.getter
    def rotations(self) -> Sequence['outputs.GetSmServiceCredentialsSecretRotationResult']:
    ...
    def source_services(self) -> Sequence['outputs.GetSmServiceCredentialsSecretSourceServiceResult']:
...
class AwaitableGetSmServiceCredentialsSecretResult(GetSmServiceCredentialsSecretResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmServiceCredentialsSecretResult(
...
def get_sm_service_credentials_secret(endpoint_type: Optional[_builtins.str] = None,
                                      instance_id: Optional[_builtins.str] = None,
                                      name: Optional[_builtins.str] = None,
                                      region: Optional[_builtins.str] = None,
                                      secret_group_name: Optional[_builtins.str] = None,
                                      secret_id: Optional[_builtins.str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmServiceCredentialsSecretResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmServiceCredentialsSecret:getSmServiceCredentialsSecret', __args__, opts=opts, typ=GetSmServiceCredentialsSecretResult).value

    return AwaitableGetSmServiceCredentialsSecretResult(
...
def get_sm_service_credentials_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmServiceCredentialsSecretResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmServiceCredentialsSecret:getSmServiceCredentialsSecret', __args__, opts=opts, typ=GetSmServiceCredentialsSecretResult)
    return __ret__.apply(lambda __response__: GetSmServiceCredentialsSecretResult(
