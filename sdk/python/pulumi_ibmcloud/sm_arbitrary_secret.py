...
__all__ = ['SmArbitrarySecretArgs', 'SmArbitrarySecret']

@pulumi.input_type
class SmArbitrarySecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] payload: The arbitrary secret data payload.
...
class _SmArbitrarySecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] custom_metadata: The secret metadata that a user can customize.
        :param pulumi.Input[_builtins.str] description: An extended description of your secret.To protect your privacy, do not use personal data, such as your name or location, as a description for your secret group.
        :param pulumi.Input[_builtins.bool] downloaded: Indicates whether the secret data that is associated with a secret version was retrieved.
        :param pulumi.Input[_builtins.str] endpoint_type: public or private.
        :param pulumi.Input[_builtins.str] expiration_date: The date a secret is expired. The date format follows RFC 3339.
        :param pulumi.Input[_builtins.str] instance_id: The ID of the Secrets Manager instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] labels: Labels that you can use to search for secrets in your instance.Up to 30 labels can be created.
...
@pulumi.type_token("ibmcloud:index/smArbitrarySecret:SmArbitrarySecret")
class SmArbitrarySecret(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SmArbitrarySecret resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SmArbitrarySecretArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SmArbitrarySecret resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SmArbitrarySecretArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmArbitrarySecretArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmArbitrarySecretArgs.__new__(SmArbitrarySecretArgs)
        ...
        super(SmArbitrarySecret, __self__).__init__(
            'ibmcloud:index/smArbitrarySecret:SmArbitrarySecret',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            versions_total: Optional[pulumi.Input[_builtins.int]] = None) -> 'SmArbitrarySecret':
        """
        ...
        __props__ = _SmArbitrarySecretState.__new__(_SmArbitrarySecretState)
        ...
        return SmArbitrarySecret(resource_name, opts=opts, __props__=__props__)
