...
__all__ = [
    'GetContainerVpcClusterAlbResult',
    'AwaitableGetContainerVpcClusterAlbResult',
    'get_container_vpc_cluster_alb',
    'get_container_vpc_cluster_alb_output',
]

@pulumi.output_type
class GetContainerVpcClusterAlbResult:
    """
...
class AwaitableGetContainerVpcClusterAlbResult(GetContainerVpcClusterAlbResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetContainerVpcClusterAlbResult(
            alb_id=self.alb_id,
...
def get_container_vpc_cluster_alb(alb_id: Optional[_builtins.str] = None,
                                  resource_group_id: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContainerVpcClusterAlbResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getContainerVpcClusterAlb:getContainerVpcClusterAlb', __args__, opts=opts, typ=GetContainerVpcClusterAlbResult).value

    return AwaitableGetContainerVpcClusterAlbResult(
...
def get_container_vpc_cluster_alb_output(alb_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         resource_group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetContainerVpcClusterAlbResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getContainerVpcClusterAlb:getContainerVpcClusterAlb', __args__, opts=opts, typ=GetContainerVpcClusterAlbResult)
    return __ret__.apply(lambda __response__: GetContainerVpcClusterAlbResult(
