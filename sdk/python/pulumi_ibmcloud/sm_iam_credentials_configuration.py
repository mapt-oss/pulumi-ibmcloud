...
class SmIamCredentialsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api_key: An IBM Cloud API key that can create and manage service IDs. The API key must be assigned the Editor platform role on the Access Groups Service and the Operator platform role on the IAM Identity Service. For more information, see the [docs](https://cloud.ibm.com/docs/secrets-manager?topic=secrets-manager-configure-iam-engine).
        :param pulumi.Input[_builtins.str] instance_id: The ID of the Secrets Manager instance.
        :param pulumi.Input[_builtins.bool] disabled: This attribute indicates whether the API key configuration is disabled. If it is set to `true`, the IAM credentials engine doesn't use the configured API key for credentials management.
...
@pulumi.type_token("ibmcloud:index/smIamCredentialsConfiguration:SmIamCredentialsConfiguration")
class SmIamCredentialsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SmIamCredentialsConfiguration, __self__).__init__(
            'ibmcloud:index/smIamCredentialsConfiguration:SmIamCredentialsConfiguration',
            resource_name,
            __props__,
            opts)
