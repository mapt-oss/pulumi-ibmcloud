...
__all__ = [
    'GetEnDestinationWebhookResult',
    'AwaitableGetEnDestinationWebhookResult',
    'get_en_destination_webhook',
    'get_en_destination_webhook_output',
]

@pulumi.output_type
class GetEnDestinationWebhookResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationWebhookConfigResult']:
...
class AwaitableGetEnDestinationWebhookResult(GetEnDestinationWebhookResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationWebhookResult(
...
def get_en_destination_webhook(destination_id: Optional[_builtins.str] = None,
                               instance_guid: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationWebhookResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationWebhook:getEnDestinationWebhook', __args__, opts=opts, typ=GetEnDestinationWebhookResult).value

    return AwaitableGetEnDestinationWebhookResult(
...
def get_en_destination_webhook_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationWebhookResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationWebhook:getEnDestinationWebhook', __args__, opts=opts, typ=GetEnDestinationWebhookResult)
    return __ret__.apply(lambda __response__: GetEnDestinationWebhookResult(
