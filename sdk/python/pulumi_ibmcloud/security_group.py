...
class SecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Security group description
...
@pulumi.type_token("ibmcloud:index/securityGroup:SecurityGroup")
class SecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SecurityGroup, __self__).__init__(
            'ibmcloud:index/securityGroup:SecurityGroup',
            resource_name,
            __props__,
            opts)
