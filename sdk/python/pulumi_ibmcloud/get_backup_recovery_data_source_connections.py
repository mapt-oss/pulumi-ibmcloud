...
class GetBackupRecoveryDataSourceConnectionsResult:
    ...
    """
    def __init__(__self__, connection_ids=None, connection_names=None, connections=None, endpoint_type=None, id=None, instance_id=None, region=None, x_ibm_tenant_id=None):
...
def get_backup_recovery_data_source_connections(connection_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getBackupRecoveryDataSourceConnections:getBackupRecoveryDataSourceConnections', __args__, opts=opts, typ=GetBackupRecoveryDataSourceConnectionsResult).value
...
def get_backup_recovery_data_source_connections_output(connection_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getBackupRecoveryDataSourceConnections:getBackupRecoveryDataSourceConnections', __args__, opts=opts, typ=GetBackupRecoveryDataSourceConnectionsResult)
