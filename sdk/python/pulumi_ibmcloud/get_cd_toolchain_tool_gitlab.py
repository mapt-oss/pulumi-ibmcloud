...
__all__ = [
    'GetCdToolchainToolGitlabResult',
    'AwaitableGetCdToolchainToolGitlabResult',
    'get_cd_toolchain_tool_gitlab',
    'get_cd_toolchain_tool_gitlab_output',
]

@pulumi.output_type
class GetCdToolchainToolGitlabResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolGitlabParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolGitlabReferentResult']:
...
class AwaitableGetCdToolchainToolGitlabResult(GetCdToolchainToolGitlabResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolGitlabResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_gitlab(tool_id: Optional[_builtins.str] = None,
                                 toolchain_id: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolGitlabResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolGitlab:getCdToolchainToolGitlab', __args__, opts=opts, typ=GetCdToolchainToolGitlabResult).value

    return AwaitableGetCdToolchainToolGitlabResult(
...
def get_cd_toolchain_tool_gitlab_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolGitlabResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolGitlab:getCdToolchainToolGitlab', __args__, opts=opts, typ=GetCdToolchainToolGitlabResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolGitlabResult(
