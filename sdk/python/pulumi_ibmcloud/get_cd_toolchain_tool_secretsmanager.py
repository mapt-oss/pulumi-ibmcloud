...
__all__ = [
    'GetCdToolchainToolSecretsmanagerResult',
    'AwaitableGetCdToolchainToolSecretsmanagerResult',
    'get_cd_toolchain_tool_secretsmanager',
    'get_cd_toolchain_tool_secretsmanager_output',
]

@pulumi.output_type
class GetCdToolchainToolSecretsmanagerResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolSecretsmanagerParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolSecretsmanagerReferentResult']:
...
class AwaitableGetCdToolchainToolSecretsmanagerResult(GetCdToolchainToolSecretsmanagerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolSecretsmanagerResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_secretsmanager(tool_id: Optional[_builtins.str] = None,
                                         toolchain_id: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolSecretsmanagerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolSecretsmanager:getCdToolchainToolSecretsmanager', __args__, opts=opts, typ=GetCdToolchainToolSecretsmanagerResult).value

    return AwaitableGetCdToolchainToolSecretsmanagerResult(
...
def get_cd_toolchain_tool_secretsmanager_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolSecretsmanagerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolSecretsmanager:getCdToolchainToolSecretsmanager', __args__, opts=opts, typ=GetCdToolchainToolSecretsmanagerResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolSecretsmanagerResult(
