...
__all__ = [
    'GetCdToolchainToolSonarqubeResult',
    'AwaitableGetCdToolchainToolSonarqubeResult',
    'get_cd_toolchain_tool_sonarqube',
    'get_cd_toolchain_tool_sonarqube_output',
]

@pulumi.output_type
class GetCdToolchainToolSonarqubeResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolSonarqubeParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolSonarqubeReferentResult']:
...
class AwaitableGetCdToolchainToolSonarqubeResult(GetCdToolchainToolSonarqubeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolSonarqubeResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_sonarqube(tool_id: Optional[_builtins.str] = None,
                                    toolchain_id: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolSonarqubeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolSonarqube:getCdToolchainToolSonarqube', __args__, opts=opts, typ=GetCdToolchainToolSonarqubeResult).value

    return AwaitableGetCdToolchainToolSonarqubeResult(
...
def get_cd_toolchain_tool_sonarqube_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolSonarqubeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolSonarqube:getCdToolchainToolSonarqube', __args__, opts=opts, typ=GetCdToolchainToolSonarqubeResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolSonarqubeResult(
