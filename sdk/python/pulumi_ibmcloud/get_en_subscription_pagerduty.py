...
def get_en_subscription_pagerduty(instance_guid: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnSubscriptionPagerduty:getEnSubscriptionPagerduty', __args__, opts=opts, typ=GetEnSubscriptionPagerdutyResult).value
...
def get_en_subscription_pagerduty_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnSubscriptionPagerduty:getEnSubscriptionPagerduty', __args__, opts=opts, typ=GetEnSubscriptionPagerdutyResult)
