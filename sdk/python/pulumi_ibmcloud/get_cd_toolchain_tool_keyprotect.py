...
__all__ = [
    'GetCdToolchainToolKeyprotectResult',
    'AwaitableGetCdToolchainToolKeyprotectResult',
    'get_cd_toolchain_tool_keyprotect',
    'get_cd_toolchain_tool_keyprotect_output',
]

@pulumi.output_type
class GetCdToolchainToolKeyprotectResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolKeyprotectParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolKeyprotectReferentResult']:
...
class AwaitableGetCdToolchainToolKeyprotectResult(GetCdToolchainToolKeyprotectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolKeyprotectResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_keyprotect(tool_id: Optional[_builtins.str] = None,
                                     toolchain_id: Optional[_builtins.str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolKeyprotectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolKeyprotect:getCdToolchainToolKeyprotect', __args__, opts=opts, typ=GetCdToolchainToolKeyprotectResult).value

    return AwaitableGetCdToolchainToolKeyprotectResult(
...
def get_cd_toolchain_tool_keyprotect_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolKeyprotectResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolKeyprotect:getCdToolchainToolKeyprotect', __args__, opts=opts, typ=GetCdToolchainToolKeyprotectResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolKeyprotectResult(
