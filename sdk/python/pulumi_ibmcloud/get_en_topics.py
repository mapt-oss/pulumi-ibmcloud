...
__all__ = [
    'GetEnTopicsResult',
    'AwaitableGetEnTopicsResult',
    'get_en_topics',
    'get_en_topics_output',
]

@pulumi.output_type
class GetEnTopicsResult:
    """
    A collection of values returned by getEnTopics.
    """
    def __init__(__self__, id=None, instance_guid=None, search_key=None, topics=None, total_count=None):
    ...
    @_builtins.property
    @pulumi.getter
    def topics(self) -> Sequence['outputs.GetEnTopicsTopicResult']:
...
class AwaitableGetEnTopicsResult(GetEnTopicsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnTopicsResult(
            id=self.id,
...
def get_en_topics(instance_guid: Optional[_builtins.str] = None,
                  search_key: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnTopicsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnTopics:getEnTopics', __args__, opts=opts, typ=GetEnTopicsResult).value

    return AwaitableGetEnTopicsResult(
        id=pulumi.get(__ret__, 'id'),
        instance_guid=pulumi.get(__ret__, 'instance_guid'),
        search_key=pulumi.get(__ret__, 'search_key'),
        topics=pulumi.get(__ret__, 'topics'),
        total_count=pulumi.get(__ret__, 'total_count'))
def get_en_topics_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                         search_key: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnTopicsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnTopics:getEnTopics', __args__, opts=opts, typ=GetEnTopicsResult)
    return __ret__.apply(lambda __response__: GetEnTopicsResult(
