...
__all__ = [
    'GetEnSubscriptionCeResult',
    'AwaitableGetEnSubscriptionCeResult',
    'get_en_subscription_ce',
    'get_en_subscription_ce_output',
]

@pulumi.output_type
class GetEnSubscriptionCeResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def attributes(self) -> Sequence['outputs.GetEnSubscriptionCeAttributeResult']:
...
class AwaitableGetEnSubscriptionCeResult(GetEnSubscriptionCeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnSubscriptionCeResult(
...
def get_en_subscription_ce(instance_guid: Optional[_builtins.str] = None,
                           subscription_id: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnSubscriptionCeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnSubscriptionCe:getEnSubscriptionCe', __args__, opts=opts, typ=GetEnSubscriptionCeResult).value

    return AwaitableGetEnSubscriptionCeResult(
...
def get_en_subscription_ce_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                  subscription_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnSubscriptionCeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnSubscriptionCe:getEnSubscriptionCe', __args__, opts=opts, typ=GetEnSubscriptionCeResult)
    return __ret__.apply(lambda __response__: GetEnSubscriptionCeResult(
