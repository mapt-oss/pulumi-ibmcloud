...
__all__ = [
    'GetEnDestinationHuaweiResult',
    'AwaitableGetEnDestinationHuaweiResult',
    'get_en_destination_huawei',
    'get_en_destination_huawei_output',
]

@pulumi.output_type
class GetEnDestinationHuaweiResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationHuaweiConfigResult']:
...
class AwaitableGetEnDestinationHuaweiResult(GetEnDestinationHuaweiResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationHuaweiResult(
...
def get_en_destination_huawei(destination_id: Optional[_builtins.str] = None,
                              instance_guid: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationHuaweiResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationHuawei:getEnDestinationHuawei', __args__, opts=opts, typ=GetEnDestinationHuaweiResult).value

    return AwaitableGetEnDestinationHuaweiResult(
...
def get_en_destination_huawei_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationHuaweiResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationHuawei:getEnDestinationHuawei', __args__, opts=opts, typ=GetEnDestinationHuaweiResult)
    return __ret__.apply(lambda __response__: GetEnDestinationHuaweiResult(
