...
__all__ = [
    'GetEnDestinationSnResult',
    'AwaitableGetEnDestinationSnResult',
    'get_en_destination_sn',
    'get_en_destination_sn_output',
]

@pulumi.output_type
class GetEnDestinationSnResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetEnDestinationSnConfigResult']:
...
class AwaitableGetEnDestinationSnResult(GetEnDestinationSnResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationSnResult(
...
def get_en_destination_sn(destination_id: Optional[_builtins.str] = None,
                          instance_guid: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationSnResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationSn:getEnDestinationSn', __args__, opts=opts, typ=GetEnDestinationSnResult).value

    return AwaitableGetEnDestinationSnResult(
...
def get_en_destination_sn_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationSnResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationSn:getEnDestinationSn', __args__, opts=opts, typ=GetEnDestinationSnResult)
    return __ret__.apply(lambda __response__: GetEnDestinationSnResult(
