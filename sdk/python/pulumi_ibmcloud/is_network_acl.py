...
__all__ = ['IsNetworkAclArgs', 'IsNetworkAcl']
...
class IsNetworkAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vpc: Network ACL VPC name
        """
...
@pulumi.type_token("ibmcloud:index/isNetworkAcl:IsNetworkAcl")
class IsNetworkAcl(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IsNetworkAclArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(IsNetworkAcl, __self__).__init__(
            'ibmcloud:index/isNetworkAcl:IsNetworkAcl',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _IsNetworkAclState.__new__(_IsNetworkAclState)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["vpc"] = vpc
        return IsNetworkAcl(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.IsNetworkAclRule']]:
        return pulumi.get(self, "rules")
