...
__all__ = [
    'GetCdToolchainToolHashicorpvaultResult',
    'AwaitableGetCdToolchainToolHashicorpvaultResult',
    'get_cd_toolchain_tool_hashicorpvault',
    'get_cd_toolchain_tool_hashicorpvault_output',
]

@pulumi.output_type
class GetCdToolchainToolHashicorpvaultResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolHashicorpvaultParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolHashicorpvaultReferentResult']:
...
class AwaitableGetCdToolchainToolHashicorpvaultResult(GetCdToolchainToolHashicorpvaultResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolHashicorpvaultResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_hashicorpvault(tool_id: Optional[_builtins.str] = None,
                                         toolchain_id: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolHashicorpvaultResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolHashicorpvault:getCdToolchainToolHashicorpvault', __args__, opts=opts, typ=GetCdToolchainToolHashicorpvaultResult).value

    return AwaitableGetCdToolchainToolHashicorpvaultResult(
...
def get_cd_toolchain_tool_hashicorpvault_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolHashicorpvaultResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolHashicorpvault:getCdToolchainToolHashicorpvault', __args__, opts=opts, typ=GetCdToolchainToolHashicorpvaultResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolHashicorpvaultResult(
