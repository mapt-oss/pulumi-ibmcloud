...
__all__ = [
    'GetEnDestinationCustomSmsResult',
    'AwaitableGetEnDestinationCustomSmsResult',
    'get_en_destination_custom_sms',
    'get_en_destination_custom_sms_output',
]

@pulumi.output_type
class GetEnDestinationCustomSmsResult:
    """
    A collection of values returned by getEnDestinationCustomSms.
    """
    def __init__(__self__, collect_failed_events=None, description=None, destination_id=None, id=None, instance_guid=None, name=None, subscription_count=None, subscription_names=None, type=None, updated_at=None):
...
class AwaitableGetEnDestinationCustomSmsResult(GetEnDestinationCustomSmsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnDestinationCustomSmsResult(
...
def get_en_destination_custom_sms(destination_id: Optional[_builtins.str] = None,
                                  instance_guid: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnDestinationCustomSmsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnDestinationCustomSms:getEnDestinationCustomSms', __args__, opts=opts, typ=GetEnDestinationCustomSmsResult).value

    return AwaitableGetEnDestinationCustomSmsResult(
...
def get_en_destination_custom_sms_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnDestinationCustomSmsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnDestinationCustomSms:getEnDestinationCustomSms', __args__, opts=opts, typ=GetEnDestinationCustomSmsResult)
    return __ret__.apply(lambda __response__: GetEnDestinationCustomSmsResult(
