...
__all__ = [
    'GetCdToolchainToolArtifactoryResult',
    'AwaitableGetCdToolchainToolArtifactoryResult',
    'get_cd_toolchain_tool_artifactory',
    'get_cd_toolchain_tool_artifactory_output',
]

@pulumi.output_type
class GetCdToolchainToolArtifactoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolArtifactoryParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolArtifactoryReferentResult']:
...
class AwaitableGetCdToolchainToolArtifactoryResult(GetCdToolchainToolArtifactoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolArtifactoryResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_artifactory(tool_id: Optional[_builtins.str] = None,
                                      toolchain_id: Optional[_builtins.str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolArtifactoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolArtifactory:getCdToolchainToolArtifactory', __args__, opts=opts, typ=GetCdToolchainToolArtifactoryResult).value

    return AwaitableGetCdToolchainToolArtifactoryResult(
...
def get_cd_toolchain_tool_artifactory_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                             toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolArtifactoryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolArtifactory:getCdToolchainToolArtifactory', __args__, opts=opts, typ=GetCdToolchainToolArtifactoryResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolArtifactoryResult(
