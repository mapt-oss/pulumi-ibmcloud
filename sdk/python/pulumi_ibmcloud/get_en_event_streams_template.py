...
__all__ = [
    'GetEnEventStreamsTemplateResult',
    'AwaitableGetEnEventStreamsTemplateResult',
    'get_en_event_streams_template',
    'get_en_event_streams_template_output',
]

@pulumi.output_type
class GetEnEventStreamsTemplateResult:
    """
...
class AwaitableGetEnEventStreamsTemplateResult(GetEnEventStreamsTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnEventStreamsTemplateResult(
...
def get_en_event_streams_template(instance_guid: Optional[_builtins.str] = None,
                                  template_id: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnEventStreamsTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnEventStreamsTemplate:getEnEventStreamsTemplate', __args__, opts=opts, typ=GetEnEventStreamsTemplateResult).value

    return AwaitableGetEnEventStreamsTemplateResult(
...
def get_en_event_streams_template_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
                                         template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnEventStreamsTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnEventStreamsTemplate:getEnEventStreamsTemplate', __args__, opts=opts, typ=GetEnEventStreamsTemplateResult)
    return __ret__.apply(lambda __response__: GetEnEventStreamsTemplateResult(
