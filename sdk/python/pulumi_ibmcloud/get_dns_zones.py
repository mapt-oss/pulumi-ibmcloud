...
def get_dns_zones(instance_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getDnsZones:getDnsZones', __args__, opts=opts, typ=GetDnsZonesResult).value

    return AwaitableGetDnsZonesResult(
        dns_zones=pulumi.get(__ret__, 'dns_zones'),
        id=pulumi.get(__ret__, 'id'),
        instance_id=pulumi.get(__ret__, 'instance_id'))
def get_dns_zones_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getDnsZones:getDnsZones', __args__, opts=opts, typ=GetDnsZonesResult)
