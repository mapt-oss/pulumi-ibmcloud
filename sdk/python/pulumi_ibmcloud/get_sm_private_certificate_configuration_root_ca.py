...
__all__ = [
    'GetSmPrivateCertificateConfigurationRootCaResult',
    'AwaitableGetSmPrivateCertificateConfigurationRootCaResult',
    'get_sm_private_certificate_configuration_root_ca',
    'get_sm_private_certificate_configuration_root_ca_output',
]

@pulumi.output_type
class GetSmPrivateCertificateConfigurationRootCaResult:
    """
    A collection of values returned by getSmPrivateCertificateConfigurationRootCa.
    """
    def __init__(__self__, alt_names=None, common_name=None, config_type=None, countries=None, created_at=None, created_by=None, crl_disable=None, crl_distribution_points_encoded=None, crl_expiry_seconds=None, crypto_keys=None, datas=None, endpoint_type=None, exclude_cn_from_sans=None, expiration_date=None, format=None, id=None, instance_id=None, ip_sans=None, issuing_certificates_urls_encoded=None, key_bits=None, key_type=None, localities=None, max_path_length=None, max_ttl_seconds=None, name=None, organizations=None, other_sans=None, ous=None, permitted_dns_domains=None, postal_codes=None, private_key_format=None, provinces=None, region=None, secret_type=None, serial_number=None, status=None, street_addresses=None, ttl_seconds=None, updated_at=None, uri_sans=None):
        ...
        if max_path_length and not isinstance(max_path_length, int):
            raise TypeError("Expected argument 'max_path_length' to be a int")
        ...
        if permitted_dns_domains and not isinstance(permitted_dns_domains, list):
            raise TypeError("Expected argument 'permitted_dns_domains' to be a list")
    ...
    def crypto_keys(self) -> Sequence['outputs.GetSmPrivateCertificateConfigurationRootCaCryptoKeyResult']:
        return pulumi.get(self, "crypto_keys")

    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetSmPrivateCertificateConfigurationRootCaDataResult']:
...
class AwaitableGetSmPrivateCertificateConfigurationRootCaResult(GetSmPrivateCertificateConfigurationRootCaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmPrivateCertificateConfigurationRootCaResult(
...
def get_sm_private_certificate_configuration_root_ca(endpoint_type: Optional[_builtins.str] = None,
                                                     instance_id: Optional[_builtins.str] = None,
                                                     name: Optional[_builtins.str] = None,
                                                     region: Optional[_builtins.str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmPrivateCertificateConfigurationRootCaResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmPrivateCertificateConfigurationRootCa:getSmPrivateCertificateConfigurationRootCa', __args__, opts=opts, typ=GetSmPrivateCertificateConfigurationRootCaResult).value

    return AwaitableGetSmPrivateCertificateConfigurationRootCaResult(
        ...
        max_path_length=pulumi.get(__ret__, 'max_path_length'),
        ...
        permitted_dns_domains=pulumi.get(__ret__, 'permitted_dns_domains'),
...
def get_sm_private_certificate_configuration_root_ca_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                            name: Optional[pulumi.Input[_builtins.str]] = None,
                                                            region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmPrivateCertificateConfigurationRootCaResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmPrivateCertificateConfigurationRootCa:getSmPrivateCertificateConfigurationRootCa', __args__, opts=opts, typ=GetSmPrivateCertificateConfigurationRootCaResult)
    return __ret__.apply(lambda __response__: GetSmPrivateCertificateConfigurationRootCaResult(
        ...
        max_path_length=pulumi.get(__response__, 'max_path_length'),
        ...
        permitted_dns_domains=pulumi.get(__response__, 'permitted_dns_domains'),
