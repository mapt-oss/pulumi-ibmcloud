...
__all__ = [
    'GetCdToolchainToolHostedgitResult',
    'AwaitableGetCdToolchainToolHostedgitResult',
    'get_cd_toolchain_tool_hostedgit',
    'get_cd_toolchain_tool_hostedgit_output',
]

@pulumi.output_type
class GetCdToolchainToolHostedgitResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolHostedgitParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolHostedgitReferentResult']:
...
class AwaitableGetCdToolchainToolHostedgitResult(GetCdToolchainToolHostedgitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolHostedgitResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_hostedgit(tool_id: Optional[_builtins.str] = None,
                                    toolchain_id: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolHostedgitResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolHostedgit:getCdToolchainToolHostedgit', __args__, opts=opts, typ=GetCdToolchainToolHostedgitResult).value

    return AwaitableGetCdToolchainToolHostedgitResult(
...
def get_cd_toolchain_tool_hostedgit_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolHostedgitResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolHostedgit:getCdToolchainToolHostedgit', __args__, opts=opts, typ=GetCdToolchainToolHostedgitResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolHostedgitResult(
