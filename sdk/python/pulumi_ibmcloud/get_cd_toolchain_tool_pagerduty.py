...
def get_cd_toolchain_tool_pagerduty(tool_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolPagerduty:getCdToolchainToolPagerduty', __args__, opts=opts, typ=GetCdToolchainToolPagerdutyResult).value
...
def get_cd_toolchain_tool_pagerduty_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolPagerduty:getCdToolchainToolPagerduty', __args__, opts=opts, typ=GetCdToolchainToolPagerdutyResult)
