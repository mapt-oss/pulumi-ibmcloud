...
def get_schematics_agent_deploy(agent_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSchematicsAgentDeploy:getSchematicsAgentDeploy', __args__, opts=opts, typ=GetSchematicsAgentDeployResult).value
...
def get_schematics_agent_deploy_output(agent_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSchematicsAgentDeploy:getSchematicsAgentDeploy', __args__, opts=opts, typ=GetSchematicsAgentDeployResult)
