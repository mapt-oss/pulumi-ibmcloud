...
__all__ = [
    'GetCdToolchainToolBitbucketgitResult',
    'AwaitableGetCdToolchainToolBitbucketgitResult',
    'get_cd_toolchain_tool_bitbucketgit',
    'get_cd_toolchain_tool_bitbucketgit_output',
]

@pulumi.output_type
class GetCdToolchainToolBitbucketgitResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolBitbucketgitParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolBitbucketgitReferentResult']:
...
class AwaitableGetCdToolchainToolBitbucketgitResult(GetCdToolchainToolBitbucketgitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolBitbucketgitResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_bitbucketgit(tool_id: Optional[_builtins.str] = None,
                                       toolchain_id: Optional[_builtins.str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolBitbucketgitResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolBitbucketgit:getCdToolchainToolBitbucketgit', __args__, opts=opts, typ=GetCdToolchainToolBitbucketgitResult).value

    return AwaitableGetCdToolchainToolBitbucketgitResult(
...
def get_cd_toolchain_tool_bitbucketgit_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                              toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolBitbucketgitResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolBitbucketgit:getCdToolchainToolBitbucketgit', __args__, opts=opts, typ=GetCdToolchainToolBitbucketgitResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolBitbucketgitResult(
