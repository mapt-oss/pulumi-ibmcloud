...
__all__ = [
    'GetIsVpnGatewayConnectionPeerCidrsResult',
    'AwaitableGetIsVpnGatewayConnectionPeerCidrsResult',
    'get_is_vpn_gateway_connection_peer_cidrs',
    'get_is_vpn_gateway_connection_peer_cidrs_output',
]

@pulumi.output_type
class GetIsVpnGatewayConnectionPeerCidrsResult:
    """
...
class AwaitableGetIsVpnGatewayConnectionPeerCidrsResult(GetIsVpnGatewayConnectionPeerCidrsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIsVpnGatewayConnectionPeerCidrsResult(
            cidrs=self.cidrs,
            id=self.id,
...
def get_is_vpn_gateway_connection_peer_cidrs(vpn_gateway: Optional[_builtins.str] = None,
                                             vpn_gateway_connection: Optional[_builtins.str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIsVpnGatewayConnectionPeerCidrsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getIsVpnGatewayConnectionPeerCidrs:getIsVpnGatewayConnectionPeerCidrs', __args__, opts=opts, typ=GetIsVpnGatewayConnectionPeerCidrsResult).value

    return AwaitableGetIsVpnGatewayConnectionPeerCidrsResult(
...
def get_is_vpn_gateway_connection_peer_cidrs_output(vpn_gateway: Optional[pulumi.Input[_builtins.str]] = None,
                                                    vpn_gateway_connection: Optional[pulumi.Input[_builtins.str]] = None,
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIsVpnGatewayConnectionPeerCidrsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getIsVpnGatewayConnectionPeerCidrs:getIsVpnGatewayConnectionPeerCidrs', __args__, opts=opts, typ=GetIsVpnGatewayConnectionPeerCidrsResult)
    return __ret__.apply(lambda __response__: GetIsVpnGatewayConnectionPeerCidrsResult(
