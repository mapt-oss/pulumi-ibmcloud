...
class IsBareMetalServerNetworkInterfaceInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] allowed_vlans: Indicates what VLAN IDs (for VLAN type only) can use this physical (PCI type) interface. A given VLAN can only be in the allowed_vlans array for one PCI type adapter per bare metal server.
...
@pulumi.type_token("ibmcloud:index/isBareMetalServerNetworkInterface:IsBareMetalServerNetworkInterface")
class IsBareMetalServerNetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IsBareMetalServerNetworkInterface, __self__).__init__(
            'ibmcloud:index/isBareMetalServerNetworkInterface:IsBareMetalServerNetworkInterface',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            vlan: Optional[pulumi.Input[_builtins.int]] = None) -> 'IsBareMetalServerNetworkInterface':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="allowedVlans")
    def allowed_vlans(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        Indicates what VLAN IDs (for VLAN type only) can use this physical (PCI type) interface. A given VLAN can only be in the allowed_vlans array for one PCI type adapter per bare metal server.
        """
        return pulumi.get(self, "allowed_vlans")
    ...
    @_builtins.property
    @pulumi.getter(name="primaryIp")
    def primary_ip(self) -> pulumi.Output['outputs.IsBareMetalServerNetworkInterfacePrimaryIp']:
        """
        title: IPv4, The IP address.
        """
        return pulumi.get(self, "primary_ip")
