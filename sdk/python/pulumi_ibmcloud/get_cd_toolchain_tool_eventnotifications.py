...
__all__ = [
    'GetCdToolchainToolEventnotificationsResult',
    'AwaitableGetCdToolchainToolEventnotificationsResult',
    'get_cd_toolchain_tool_eventnotifications',
    'get_cd_toolchain_tool_eventnotifications_output',
]

@pulumi.output_type
class GetCdToolchainToolEventnotificationsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolEventnotificationsParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolEventnotificationsReferentResult']:
...
class AwaitableGetCdToolchainToolEventnotificationsResult(GetCdToolchainToolEventnotificationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolEventnotificationsResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_eventnotifications(tool_id: Optional[_builtins.str] = None,
                                             toolchain_id: Optional[_builtins.str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolEventnotificationsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolEventnotifications:getCdToolchainToolEventnotifications', __args__, opts=opts, typ=GetCdToolchainToolEventnotificationsResult).value

    return AwaitableGetCdToolchainToolEventnotificationsResult(
...
def get_cd_toolchain_tool_eventnotifications_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolEventnotificationsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolEventnotifications:getCdToolchainToolEventnotifications', __args__, opts=opts, typ=GetCdToolchainToolEventnotificationsResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolEventnotificationsResult(
