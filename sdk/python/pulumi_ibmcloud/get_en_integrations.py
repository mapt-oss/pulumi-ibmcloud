...
def get_en_integrations(instance_guid: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getEnIntegrations:getEnIntegrations', __args__, opts=opts, typ=GetEnIntegrationsResult).value
...
def get_en_integrations_output(instance_guid: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getEnIntegrations:getEnIntegrations', __args__, opts=opts, typ=GetEnIntegrationsResult)
