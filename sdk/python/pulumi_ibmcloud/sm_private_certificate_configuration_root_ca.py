...
__all__ = ['SmPrivateCertificateConfigurationRootCaArgs', 'SmPrivateCertificateConfigurationRootCa']

@pulumi.input_type
class SmPrivateCertificateConfigurationRootCaArgs:
    def __init__(__self__, *,
                 ...
                 crypto_key: Optional[pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs']] = None,
        ...
        :param pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs'] crypto_key: The data that is associated with a cryptographic key.
    ...
    def crypto_key(self) -> Optional[pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs']]:
        """
    ...
    @crypto_key.setter
    def crypto_key(self, value: Optional[pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs']]):
...
@pulumi.input_type
class _SmPrivateCertificateConfigurationRootCaState:
    def __init__(__self__, *,
                 alt_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 ...
                 crypto_key: Optional[pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs']] = None,
                 datas: Optional[pulumi.Input[Sequence[pulumi.Input['SmPrivateCertificateConfigurationRootCaDataArgs']]]] = None,
                 endpoint_type: Optional[pulumi.Input[_builtins.str]] = None,
                 exclude_cn_from_sans: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] crl_distribution_points_encoded: Determines whether to encode the certificate revocation list (CRL) distribution points in the certificates that are issued by this certificate authority.
        :param pulumi.Input[_builtins.str] crl_expiry: The time until the certificate revocation list (CRL) expires.The value can be supplied as a string representation of a duration in hours, such as `48h`. The default is 72 hours. In the API response, this value is returned in seconds (integer).**Note:** The CRL is rotated automatically before it expires.
        :param pulumi.Input[_builtins.int] crl_expiry_seconds: The time until the certificate revocation list (CRL) expires, in seconds.
        :param pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs'] crypto_key: The data that is associated with a cryptographic key.
        :param pulumi.Input[Sequence[pulumi.Input['SmPrivateCertificateConfigurationRootCaDataArgs']]] datas: The configuration data of your Private Certificate.
        :param pulumi.Input[_builtins.str] endpoint_type: public or private.
        :param pulumi.Input[_builtins.bool] exclude_cn_from_sans: Controls whether the common name is excluded from Subject Alternative Names (SANs).If the common name set to `true`, it is not included in DNS or Email SANs if they apply. This field can be useful if the common name is a human-readable identifier, instead of a hostname or an email address.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] street_addresses: The street address values to define in the subject field of the resulting certificate.
        :param pulumi.Input[_builtins.str] ttl: The requested time-to-live (TTL) for certificates that are created by this CA. This field's value cannot be longer than the `max_ttl` limit.The value can be supplied as a string representation of a duration in hours, for example '8760h'. In the API response, this value is returned in seconds (integer).
        :param pulumi.Input[_builtins.int] ttl_seconds: The requested time-to-live (TTL) for certificates that are created by this CA. This field's value cannot be longer than the `max_ttl` limit.The value can be supplied as a string representation of a duration in hours, for example '8760h'. In the API response, this value is returned in seconds (integer).
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SmPrivateCertificateConfigurationRootCaDataArgs']]]]:
        """
    ...
    @datas.setter
    def datas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SmPrivateCertificateConfigurationRootCaDataArgs']]]]):
...
@pulumi.type_token("ibmcloud:index/smPrivateCertificateConfigurationRootCa:SmPrivateCertificateConfigurationRootCa")
class SmPrivateCertificateConfigurationRootCa(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 crl_distribution_points_encoded: Optional[pulumi.Input[_builtins.bool]] = None,
                 crl_expiry: Optional[pulumi.Input[_builtins.str]] = None,
                 crypto_key: Optional[pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs', 'SmPrivateCertificateConfigurationRootCaCryptoKeyArgsDict']]] = None,
                 endpoint_type: Optional[pulumi.Input[_builtins.str]] = None,
                 exclude_cn_from_sans: Optional[pulumi.Input[_builtins.bool]] = None,
                 format: Optional[pulumi.Input[_builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 __props__=None):
        """
        Create a SmPrivateCertificateConfigurationRootCa resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[_builtins.bool] crl_distribution_points_encoded: Determines whether to encode the certificate revocation list (CRL) distribution points in the certificates that are issued by this certificate authority.
        :param pulumi.Input[_builtins.str] crl_expiry: The time until the certificate revocation list (CRL) expires.The value can be supplied as a string representation of a duration in hours, such as `48h`. The default is 72 hours. In the API response, this value is returned in seconds (integer).**Note:** The CRL is rotated automatically before it expires.
        :param pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs', 'SmPrivateCertificateConfigurationRootCaCryptoKeyArgsDict']] crypto_key: The data that is associated with a cryptographic key.
        :param pulumi.Input[_builtins.str] endpoint_type: public or private.
        :param pulumi.Input[_builtins.bool] exclude_cn_from_sans: Controls whether the common name is excluded from Subject Alternative Names (SANs).If the common name set to `true`, it is not included in DNS or Email SANs if they apply. This field can be useful if the common name is a human-readable identifier, instead of a hostname or an email address.
        :param pulumi.Input[_builtins.str] format: The format of the returned data.
        :param pulumi.Input[_builtins.str] instance_id: The ID of the Secrets Manager instance.
    ...
    def __init__(__self__,
        ...
        Create a SmPrivateCertificateConfigurationRootCa resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SmPrivateCertificateConfigurationRootCaArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmPrivateCertificateConfigurationRootCaArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmPrivateCertificateConfigurationRootCaArgs.__new__(SmPrivateCertificateConfigurationRootCaArgs)
        ...
        super(SmPrivateCertificateConfigurationRootCa, __self__).__init__(
            'ibmcloud:index/smPrivateCertificateConfigurationRootCa:SmPrivateCertificateConfigurationRootCa',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            crl_expiry_seconds: Optional[pulumi.Input[_builtins.int]] = None,
            crypto_key: Optional[pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs', 'SmPrivateCertificateConfigurationRootCaCryptoKeyArgsDict']]] = None,
            datas: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaDataArgs', 'SmPrivateCertificateConfigurationRootCaDataArgsDict']]]]] = None,
            endpoint_type: Optional[pulumi.Input[_builtins.str]] = None,
            exclude_cn_from_sans: Optional[pulumi.Input[_builtins.bool]] = None,
            expiration_date: Optional[pulumi.Input[_builtins.str]] = None,
            format: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            ttl_seconds: Optional[pulumi.Input[_builtins.int]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            uri_sans: Optional[pulumi.Input[_builtins.str]] = None) -> 'SmPrivateCertificateConfigurationRootCa':
        """
        ...
        :param pulumi.Input[_builtins.int] crl_expiry_seconds: The time until the certificate revocation list (CRL) expires, in seconds.
        :param pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs', 'SmPrivateCertificateConfigurationRootCaCryptoKeyArgsDict']] crypto_key: The data that is associated with a cryptographic key.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SmPrivateCertificateConfigurationRootCaDataArgs', 'SmPrivateCertificateConfigurationRootCaDataArgsDict']]]] datas: The configuration data of your Private Certificate.
        :param pulumi.Input[_builtins.str] endpoint_type: public or private.
        :param pulumi.Input[_builtins.bool] exclude_cn_from_sans: Controls whether the common name is excluded from Subject Alternative Names (SANs).If the common name set to `true`, it is not included in DNS or Email SANs if they apply. This field can be useful if the common name is a human-readable identifier, instead of a hostname or an email address.
        :param pulumi.Input[_builtins.str] expiration_date: The date a secret is expired. The date format follows RFC 3339.
        :param pulumi.Input[_builtins.str] format: The format of the returned data.
        ...
        __props__ = _SmPrivateCertificateConfigurationRootCaState.__new__(_SmPrivateCertificateConfigurationRootCaState)
        ...
        __props__.__dict__["uri_sans"] = uri_sans
        return SmPrivateCertificateConfigurationRootCa(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="cryptoKey")
    def crypto_key(self) -> pulumi.Output['outputs.SmPrivateCertificateConfigurationRootCaCryptoKey']:
        """
        The data that is associated with a cryptographic key.
        """
        return pulumi.get(self, "crypto_key")
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> pulumi.Output[Sequence['outputs.SmPrivateCertificateConfigurationRootCaData']]:
        """
        The configuration data of your Private Certificate.
        """
        return pulumi.get(self, "datas")
    ...
    @_builtins.property
    @pulumi.getter(name="permittedDnsDomains")
    def permitted_dns_domains(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The allowed DNS domains or subdomains for the certificates that are to be signed and issued by this CA certificate.
        """
        return pulumi.get(self, "permitted_dns_domains")
