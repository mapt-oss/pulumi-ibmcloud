...
class IamServicePolicyArgs:
    def __init__(__self__, *,
        ...
        if iam_service_id is not None:
            ...
            pulumi.log.warn("""iam_service_id is deprecated: This field is deprecated and will be removed starting with this 1.82.0 release. Please use iam_id field instead.""")
        if iam_service_id is not None:
...
@pulumi.type_token("ibmcloud:index/iamServicePolicy:IamServicePolicy")
class IamServicePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IamServicePolicy, __self__).__init__(
            'ibmcloud:index/iamServicePolicy:IamServicePolicy',
            resource_name,
            __props__,
            opts)
