...
class CloudantArgs:
    def __init__(__self__, *,
                 ...
                 cors_config: Optional[pulumi.Input['CloudantCorsConfigArgs']] = None,
                 enable_cors: Optional[pulumi.Input[_builtins.bool]] = None,
                 environment_crn: Optional[pulumi.Input[_builtins.str]] = None,
                 include_data_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 legacy_credentials: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.int] capacity: A number of blocks of throughput units. A block consists of 100 reads/sec, 50 writes/sec, and 5 global queries/sec of provisioned throughput capacity.
        :param pulumi.Input['CloudantCorsConfigArgs'] cors_config: Configuration for CORS.
        :param pulumi.Input[_builtins.bool] enable_cors: Boolean value to turn CORS on and off.
        :param pulumi.Input[_builtins.str] environment_crn: CRN of the IBM Cloudant Dedicated Hardware plan instance
        :param pulumi.Input[_builtins.bool] include_data_events: Include data event types in events sent to IBM Cloud Activity Tracker with LogDNA for the IBM Cloudant instance. By default only emitted events are of "management" type.
        :param pulumi.Input[_builtins.bool] legacy_credentials: Use both legacy credentials and IAM for authentication
    ...
    def cors_config(self) -> Optional[pulumi.Input['CloudantCorsConfigArgs']]:
        """
    ...
    @cors_config.setter
    def cors_config(self, value: Optional[pulumi.Input['CloudantCorsConfigArgs']]):
    ...
    def environment_crn(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        CRN of the IBM Cloudant Dedicated Hardware plan instance
        """
        return pulumi.get(self, "environment_crn")

    @environment_crn.setter
    def environment_crn(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "environment_crn", value)

    @_builtins.property
    @pulumi.getter(name="includeDataEvents")
    def include_data_events(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @include_data_events.setter
    def include_data_events(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "include_data_events", value)

    @_builtins.property
    @pulumi.getter(name="legacyCredentials")
    def legacy_credentials(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Use both legacy credentials and IAM for authentication
        """
        return pulumi.get(self, "legacy_credentials")

    @legacy_credentials.setter
    def legacy_credentials(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "legacy_credentials", value)
...
class _CloudantState:
    def __init__(__self__, *,
                 ...
                 plan_histories: Optional[pulumi.Input[Sequence[pulumi.Input['CloudantPlanHistoryArgs']]]] = None,
                 ...
                 throughput: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] parameters_json: Arbitrary parameters to pass in Json string format
        :param pulumi.Input[_builtins.str] plan: The plan type of the service
        :param pulumi.Input[Sequence[pulumi.Input['CloudantPlanHistoryArgs']]] plan_histories: The plan history of the instance.
        ...
        :param pulumi.Input[_builtins.str] service: The service type of the instance
        :param pulumi.Input[_builtins.str] service_endpoints: Types of the service endpoints. Possible values are 'public', 'private', 'public-and-private'.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]] throughput: Schema for detailed information about throughput capacity with breakdown by specific throughput requests classes.
    ...
    def plan_histories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudantPlanHistoryArgs']]]]:
        """
    ...
    def plan_histories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudantPlanHistoryArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def throughput(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]]:
        """
    ...
    @throughput.setter
    def throughput(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]]):
...
@pulumi.type_token("ibmcloud:index/cloudant:Cloudant")
class Cloudant(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 capacity: Optional[pulumi.Input[_builtins.int]] = None,
                 cors_config: Optional[pulumi.Input[Union['CloudantCorsConfigArgs', 'CloudantCorsConfigArgsDict']]] = None,
                 enable_cors: Optional[pulumi.Input[_builtins.bool]] = None,
                 environment_crn: Optional[pulumi.Input[_builtins.str]] = None,
                 include_data_events: Optional[pulumi.Input[_builtins.bool]] = None,
                 legacy_credentials: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 __props__=None):
        """
        Create a Cloudant resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.int] capacity: A number of blocks of throughput units. A block consists of 100 reads/sec, 50 writes/sec, and 5 global queries/sec of provisioned throughput capacity.
        :param pulumi.Input[Union['CloudantCorsConfigArgs', 'CloudantCorsConfigArgsDict']] cors_config: Configuration for CORS.
        :param pulumi.Input[_builtins.bool] enable_cors: Boolean value to turn CORS on and off.
        :param pulumi.Input[_builtins.str] environment_crn: CRN of the IBM Cloudant Dedicated Hardware plan instance
        :param pulumi.Input[_builtins.bool] include_data_events: Include data event types in events sent to IBM Cloud Activity Tracker with LogDNA for the IBM Cloudant instance. By default only emitted events are of "management" type.
        :param pulumi.Input[_builtins.bool] legacy_credentials: Use both legacy credentials and IAM for authentication
    ...
    def __init__(__self__,
        ...
        Create a Cloudant resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CloudantArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudantArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudantArgs.__new__(CloudantArgs)

            __props__.__dict__["capacity"] = capacity
            __props__.__dict__["cors_config"] = cors_config
            __props__.__dict__["enable_cors"] = enable_cors
            __props__.__dict__["environment_crn"] = environment_crn
            __props__.__dict__["include_data_events"] = include_data_events
            __props__.__dict__["legacy_credentials"] = legacy_credentials
        ...
        super(Cloudant, __self__).__init__(
            'ibmcloud:index/cloudant:Cloudant',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            parameters_json: Optional[pulumi.Input[_builtins.str]] = None,
            plan: Optional[pulumi.Input[_builtins.str]] = None,
            plan_histories: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CloudantPlanHistoryArgs', 'CloudantPlanHistoryArgsDict']]]]] = None,
            resource_aliases_url: Optional[pulumi.Input[_builtins.str]] = None,
            resource_bindings_url: Optional[pulumi.Input[_builtins.str]] = None,
            resource_controller_url: Optional[pulumi.Input[_builtins.str]] = None,
            resource_crn: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            update_at: Optional[pulumi.Input[_builtins.str]] = None,
            update_by: Optional[pulumi.Input[_builtins.str]] = None) -> 'Cloudant':
        """
        Get an existing Cloudant resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] parameters_json: Arbitrary parameters to pass in Json string format
        :param pulumi.Input[_builtins.str] plan: The plan type of the service
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudantPlanHistoryArgs', 'CloudantPlanHistoryArgsDict']]]] plan_histories: The plan history of the instance.
        :param pulumi.Input[_builtins.str] resource_aliases_url: The relative path to the resource aliases for the instance.
        :param pulumi.Input[_builtins.str] resource_bindings_url: The relative path to the resource bindings for the instance.
        :param pulumi.Input[_builtins.str] resource_controller_url: The URL of the IBM Cloud dashboard that can be used to explore and view details about the resource
        :param pulumi.Input[_builtins.str] resource_crn: The crn of the resource
        ...
        __props__ = _CloudantState.__new__(_CloudantState)
        ...
        return Cloudant(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="corsConfig")
    def cors_config(self) -> pulumi.Output[Optional['outputs.CloudantCorsConfig']]:
        """
        Configuration for CORS.
        """
        return pulumi.get(self, "cors_config")
    ...
    @_builtins.property
    @pulumi.getter(name="environmentCrn")
    def environment_crn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        CRN of the IBM Cloudant Dedicated Hardware plan instance
        """
        return pulumi.get(self, "environment_crn")
    ...
    @_builtins.property
    @pulumi.getter(name="includeDataEvents")
    def include_data_events(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Include data event types in events sent to IBM Cloud Activity Tracker with LogDNA for the IBM Cloudant instance. By default only emitted events are of "management" type.
        """
        return pulumi.get(self, "include_data_events")
    ...
    @_builtins.property
    @pulumi.getter(name="legacyCredentials")
    def legacy_credentials(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Use both legacy credentials and IAM for authentication
        """
        return pulumi.get(self, "legacy_credentials")
    ...
    @_builtins.property
    @pulumi.getter(name="planHistories")
    def plan_histories(self) -> pulumi.Output[Sequence['outputs.CloudantPlanHistory']]:
        """
        The plan history of the instance.
        """
        return pulumi.get(self, "plan_histories")
    ...
    @_builtins.property
    @pulumi.getter
    def throughput(self) -> pulumi.Output[Mapping[str, _builtins.int]]:
        """
        Schema for detailed information about throughput capacity with breakdown by specific throughput requests classes.
        """
        return pulumi.get(self, "throughput")
