...
__all__ = [
    'GetSmImportedCertificateResult',
    'AwaitableGetSmImportedCertificateResult',
    'get_sm_imported_certificate',
    'get_sm_imported_certificate_output',
]

@pulumi.output_type
class GetSmImportedCertificateResult:
    """
    A collection of values returned by getSmImportedCertificate.
    """
    def __init__(__self__, certificate=None, common_name=None, created_at=None, created_by=None, crn=None, csr=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, intermediate=None, intermediate_included=None, issuer=None, key_algorithm=None, labels=None, locks_total=None, managed_csrs=None, name=None, private_key=None, private_key_included=None, region=None, retrieved_at=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, serial_number=None, signing_algorithm=None, state=None, state_description=None, updated_at=None, validities=None, versions_total=None):
        ...
        if intermediate_included and not isinstance(intermediate_included, bool):
            raise TypeError("Expected argument 'intermediate_included' to be a bool")
        ...
        if managed_csrs and not isinstance(managed_csrs, list):
            raise TypeError("Expected argument 'managed_csrs' to be a list")
        pulumi.set(__self__, "managed_csrs", managed_csrs)
        ...
        if private_key_included and not isinstance(private_key_included, bool):
            raise TypeError("Expected argument 'private_key_included' to be a bool")
    ...
    def intermediate_included(self) -> _builtins.bool:
    ...
    @_builtins.property
    @pulumi.getter(name="managedCsrs")
    def managed_csrs(self) -> Sequence['outputs.GetSmImportedCertificateManagedCsrResult']:
        return pulumi.get(self, "managed_csrs")
    ...
    def private_key_included(self) -> _builtins.bool:
    ...
    @_builtins.property
    @pulumi.getter
    def validities(self) -> Sequence['outputs.GetSmImportedCertificateValidityResult']:
...
class AwaitableGetSmImportedCertificateResult(GetSmImportedCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmImportedCertificateResult(
            ...
            intermediate_included=self.intermediate_included,
            issuer=self.issuer,
            key_algorithm=self.key_algorithm,
            labels=self.labels,
            locks_total=self.locks_total,
            managed_csrs=self.managed_csrs,
            name=self.name,
            private_key=self.private_key,
            private_key_included=self.private_key_included,
            region=self.region,
...
def get_sm_imported_certificate(endpoint_type: Optional[_builtins.str] = None,
                                instance_id: Optional[_builtins.str] = None,
                                name: Optional[_builtins.str] = None,
                                region: Optional[_builtins.str] = None,
                                secret_group_name: Optional[_builtins.str] = None,
                                secret_id: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmImportedCertificateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getSmImportedCertificate:getSmImportedCertificate', __args__, opts=opts, typ=GetSmImportedCertificateResult).value

    return AwaitableGetSmImportedCertificateResult(
        ...
        intermediate_included=pulumi.get(__ret__, 'intermediate_included'),
        issuer=pulumi.get(__ret__, 'issuer'),
        key_algorithm=pulumi.get(__ret__, 'key_algorithm'),
        labels=pulumi.get(__ret__, 'labels'),
        locks_total=pulumi.get(__ret__, 'locks_total'),
        managed_csrs=pulumi.get(__ret__, 'managed_csrs'),
        name=pulumi.get(__ret__, 'name'),
        private_key=pulumi.get(__ret__, 'private_key'),
        private_key_included=pulumi.get(__ret__, 'private_key_included'),
...
def get_sm_imported_certificate_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmImportedCertificateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getSmImportedCertificate:getSmImportedCertificate', __args__, opts=opts, typ=GetSmImportedCertificateResult)
    return __ret__.apply(lambda __response__: GetSmImportedCertificateResult(
        ...
        intermediate_included=pulumi.get(__response__, 'intermediate_included'),
        issuer=pulumi.get(__response__, 'issuer'),
        key_algorithm=pulumi.get(__response__, 'key_algorithm'),
        labels=pulumi.get(__response__, 'labels'),
        locks_total=pulumi.get(__response__, 'locks_total'),
        managed_csrs=pulumi.get(__response__, 'managed_csrs'),
        name=pulumi.get(__response__, 'name'),
        private_key=pulumi.get(__response__, 'private_key'),
        private_key_included=pulumi.get(__response__, 'private_key_included'),
