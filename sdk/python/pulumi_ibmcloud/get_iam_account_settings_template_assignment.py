...
class GetIamAccountSettingsTemplateAssignmentResult:
    ...
    def template_version(self) -> Optional[_builtins.int]:
...
def get_iam_account_settings_template_assignment(assignment_id: Optional[_builtins.str] = None,
                                                 ...
                                                 template_version: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getIamAccountSettingsTemplateAssignment:getIamAccountSettingsTemplateAssignment', __args__, opts=opts, typ=GetIamAccountSettingsTemplateAssignmentResult).value
...
def get_iam_account_settings_template_assignment_output(assignment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getIamAccountSettingsTemplateAssignment:getIamAccountSettingsTemplateAssignment', __args__, opts=opts, typ=GetIamAccountSettingsTemplateAssignmentResult)
