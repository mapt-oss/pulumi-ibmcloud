...
__all__ = [
    'GetCdToolchainToolPipelineResult',
    'AwaitableGetCdToolchainToolPipelineResult',
    'get_cd_toolchain_tool_pipeline',
    'get_cd_toolchain_tool_pipeline_output',
]

@pulumi.output_type
class GetCdToolchainToolPipelineResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolPipelineParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolPipelineReferentResult']:
...
class AwaitableGetCdToolchainToolPipelineResult(GetCdToolchainToolPipelineResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolPipelineResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_pipeline(tool_id: Optional[_builtins.str] = None,
                                   toolchain_id: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolPipelineResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolPipeline:getCdToolchainToolPipeline', __args__, opts=opts, typ=GetCdToolchainToolPipelineResult).value

    return AwaitableGetCdToolchainToolPipelineResult(
...
def get_cd_toolchain_tool_pipeline_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                          toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolPipelineResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolPipeline:getCdToolchainToolPipeline', __args__, opts=opts, typ=GetCdToolchainToolPipelineResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolPipelineResult(
