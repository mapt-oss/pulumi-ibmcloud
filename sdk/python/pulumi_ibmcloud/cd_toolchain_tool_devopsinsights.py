...
__all__ = ['CdToolchainToolDevopsinsightsArgs', 'CdToolchainToolDevopsinsights']

@pulumi.input_type
class CdToolchainToolDevopsinsightsArgs:
...
@pulumi.input_type
class _CdToolchainToolDevopsinsightsState:
    def __init__(__self__, *,
                 crn: Optional[pulumi.Input[_builtins.str]] = None,
                 href: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 referents: Optional[pulumi.Input[Sequence[pulumi.Input['CdToolchainToolDevopsinsightsReferentArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the tool.
        :param pulumi.Input[Sequence[pulumi.Input['CdToolchainToolDevopsinsightsReferentArgs']]] referents: Information on URIs to access this resource through the UI or API.
    ...
    @_builtins.property
    @pulumi.getter
    def referents(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CdToolchainToolDevopsinsightsReferentArgs']]]]:
        """
    ...
    @referents.setter
    def referents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CdToolchainToolDevopsinsightsReferentArgs']]]]):
...
@pulumi.type_token("ibmcloud:index/cdToolchainToolDevopsinsights:CdToolchainToolDevopsinsights")
class CdToolchainToolDevopsinsights(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CdToolchainToolDevopsinsights resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CdToolchainToolDevopsinsightsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CdToolchainToolDevopsinsights resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CdToolchainToolDevopsinsightsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CdToolchainToolDevopsinsightsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CdToolchainToolDevopsinsightsArgs.__new__(CdToolchainToolDevopsinsightsArgs)
        ...
        super(CdToolchainToolDevopsinsights, __self__).__init__(
            'ibmcloud:index/cdToolchainToolDevopsinsights:CdToolchainToolDevopsinsights',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            href: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            referents: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CdToolchainToolDevopsinsightsReferentArgs', 'CdToolchainToolDevopsinsightsReferentArgsDict']]]]] = None,
            resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            tool_id: Optional[pulumi.Input[_builtins.str]] = None,
            toolchain_crn: Optional[pulumi.Input[_builtins.str]] = None,
            toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'CdToolchainToolDevopsinsights':
        """
        ...
        :param pulumi.Input[_builtins.str] href: URI representing the tool.
        :param pulumi.Input[_builtins.str] name: Name of the tool.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CdToolchainToolDevopsinsightsReferentArgs', 'CdToolchainToolDevopsinsightsReferentArgsDict']]]] referents: Information on URIs to access this resource through the UI or API.
        :param pulumi.Input[_builtins.str] resource_group_id: Resource group where the tool is located.
        :param pulumi.Input[_builtins.str] state: Current configuration state of the tool.
        :param pulumi.Input[_builtins.str] tool_id: Tool ID.
        :param pulumi.Input[_builtins.str] toolchain_crn: CRN of toolchain which the tool is bound to.
        ...
        __props__ = _CdToolchainToolDevopsinsightsState.__new__(_CdToolchainToolDevopsinsightsState)
        ...
        return CdToolchainToolDevopsinsights(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def referents(self) -> pulumi.Output[Sequence['outputs.CdToolchainToolDevopsinsightsReferent']]:
        """
        Information on URIs to access this resource through the UI or API.
        """
        return pulumi.get(self, "referents")
