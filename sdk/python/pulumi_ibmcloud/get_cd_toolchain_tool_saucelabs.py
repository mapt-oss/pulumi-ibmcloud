...
__all__ = [
    'GetCdToolchainToolSaucelabsResult',
    'AwaitableGetCdToolchainToolSaucelabsResult',
    'get_cd_toolchain_tool_saucelabs',
    'get_cd_toolchain_tool_saucelabs_output',
]

@pulumi.output_type
class GetCdToolchainToolSaucelabsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCdToolchainToolSaucelabsParameterResult']:
        return pulumi.get(self, "parameters")

    @_builtins.property
    @pulumi.getter
    def referents(self) -> Sequence['outputs.GetCdToolchainToolSaucelabsReferentResult']:
...
class AwaitableGetCdToolchainToolSaucelabsResult(GetCdToolchainToolSaucelabsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCdToolchainToolSaucelabsResult(
            crn=self.crn,
            href=self.href,
            id=self.id,
            name=self.name,
...
def get_cd_toolchain_tool_saucelabs(tool_id: Optional[_builtins.str] = None,
                                    toolchain_id: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdToolchainToolSaucelabsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCdToolchainToolSaucelabs:getCdToolchainToolSaucelabs', __args__, opts=opts, typ=GetCdToolchainToolSaucelabsResult).value

    return AwaitableGetCdToolchainToolSaucelabsResult(
...
def get_cd_toolchain_tool_saucelabs_output(tool_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           toolchain_id: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCdToolchainToolSaucelabsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCdToolchainToolSaucelabs:getCdToolchainToolSaucelabs', __args__, opts=opts, typ=GetCdToolchainToolSaucelabsResult)
    return __ret__.apply(lambda __response__: GetCdToolchainToolSaucelabsResult(
