...
def get_logs_e2ms(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getLogsE2ms:getLogsE2ms', __args__, opts=opts, typ=GetLogsE2msResult).value
...
def get_logs_e2ms_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getLogsE2ms:getLogsE2ms', __args__, opts=opts, typ=GetLogsE2msResult)
