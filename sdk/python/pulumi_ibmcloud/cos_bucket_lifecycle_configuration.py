...
__all__ = ['CosBucketLifecycleConfigurationArgs', 'CosBucketLifecycleConfiguration']

@pulumi.input_type
class CosBucketLifecycleConfigurationArgs:
    ...
    def lifecycle_rules(self) -> pulumi.Input[Sequence[pulumi.Input['CosBucketLifecycleConfigurationLifecycleRuleArgs']]]:
        return pulumi.get(self, "lifecycle_rules")

    @lifecycle_rules.setter
    def lifecycle_rules(self, value: pulumi.Input[Sequence[pulumi.Input['CosBucketLifecycleConfigurationLifecycleRuleArgs']]]):
...
@pulumi.type_token("ibmcloud:index/cosBucketLifecycleConfiguration:CosBucketLifecycleConfiguration")
class CosBucketLifecycleConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CosBucketLifecycleConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CosBucketLifecycleConfigurationArgs.__new__(CosBucketLifecycleConfigurationArgs)
            ...
            if lifecycle_rules is None and not opts.urn:
                raise TypeError("Missing required property 'lifecycle_rules'")
            __props__.__dict__["lifecycle_rules"] = lifecycle_rules
        super(CosBucketLifecycleConfiguration, __self__).__init__(
            'ibmcloud:index/cosBucketLifecycleConfiguration:CosBucketLifecycleConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _CosBucketLifecycleConfigurationState.__new__(_CosBucketLifecycleConfigurationState)

        __props__.__dict__["bucket_crn"] = bucket_crn
        __props__.__dict__["bucket_location"] = bucket_location
        __props__.__dict__["endpoint_type"] = endpoint_type
        __props__.__dict__["lifecycle_rules"] = lifecycle_rules
        return CosBucketLifecycleConfiguration(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="lifecycleRules")
    def lifecycle_rules(self) -> pulumi.Output[Sequence['outputs.CosBucketLifecycleConfigurationLifecycleRule']]:
        return pulumi.get(self, "lifecycle_rules")
