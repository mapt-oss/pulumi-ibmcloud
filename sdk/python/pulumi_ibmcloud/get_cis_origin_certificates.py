...
def get_cis_origin_certificates(certificate_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibmcloud:index/getCisOriginCertificates:getCisOriginCertificates', __args__, opts=opts, typ=GetCisOriginCertificatesResult).value
...
def get_cis_origin_certificates_output(certificate_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibmcloud:index/getCisOriginCertificates:getCisOriginCertificates', __args__, opts=opts, typ=GetCisOriginCertificatesResult)
