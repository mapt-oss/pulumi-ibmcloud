...
// PiImageArrayInput is an input type that accepts PiImageArray and PiImageArrayOutput values.
// You can construct a concrete instance of `PiImageArrayInput` via:
//
//	PiImageArray{ PiImageArgs{...} }
type PiImageArrayInput interface {
	pulumi.Input

	ToPiImageArrayOutput() PiImageArrayOutput
	ToPiImageArrayOutputWithContext(context.Context) PiImageArrayOutput
}

type PiImageArray []PiImageInput

func (PiImageArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]*PiImage)(nil)).Elem()
}

func (i PiImageArray) ToPiImageArrayOutput() PiImageArrayOutput {
	return i.ToPiImageArrayOutputWithContext(context.Background())
}

func (i PiImageArray) ToPiImageArrayOutputWithContext(ctx context.Context) PiImageArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PiImageArrayOutput)
}

// PiImageMapInput is an input type that accepts PiImageMap and PiImageMapOutput values.
// You can construct a concrete instance of `PiImageMapInput` via:
//
//	PiImageMap{ "key": PiImageArgs{...} }
type PiImageMapInput interface {
	pulumi.Input

	ToPiImageMapOutput() PiImageMapOutput
	ToPiImageMapOutputWithContext(context.Context) PiImageMapOutput
}

type PiImageMap map[string]PiImageInput

func (PiImageMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*PiImage)(nil)).Elem()
}

func (i PiImageMap) ToPiImageMapOutput() PiImageMapOutput {
	return i.ToPiImageMapOutputWithContext(context.Background())
}

func (i PiImageMap) ToPiImageMapOutputWithContext(ctx context.Context) PiImageMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PiImageMapOutput)
}
...
type PiImageArrayOutput struct{ *pulumi.OutputState }

func (PiImageArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]*PiImage)(nil)).Elem()
}

func (o PiImageArrayOutput) ToPiImageArrayOutput() PiImageArrayOutput {
	return o
}

func (o PiImageArrayOutput) ToPiImageArrayOutputWithContext(ctx context.Context) PiImageArrayOutput {
	return o
}

func (o PiImageArrayOutput) Index(i pulumi.IntInput) PiImageOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) *PiImage {
		return vs[0].([]*PiImage)[vs[1].(int)]
	}).(PiImageOutput)
}

type PiImageMapOutput struct{ *pulumi.OutputState }

func (PiImageMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*PiImage)(nil)).Elem()
}

func (o PiImageMapOutput) ToPiImageMapOutput() PiImageMapOutput {
	return o
}

func (o PiImageMapOutput) ToPiImageMapOutputWithContext(ctx context.Context) PiImageMapOutput {
	return o
}

func (o PiImageMapOutput) MapIndex(k pulumi.StringInput) PiImageOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) *PiImage {
		return vs[0].(map[string]*PiImage)[vs[1].(string)]
	}).(PiImageOutput)
}

func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*PiImageInput)(nil)).Elem(), &PiImage{})
	pulumi.RegisterInputType(reflect.TypeOf((*PiImageArrayInput)(nil)).Elem(), PiImageArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*PiImageMapInput)(nil)).Elem(), PiImageMap{})
	pulumi.RegisterOutputType(PiImageOutput{})
	pulumi.RegisterOutputType(PiImageArrayOutput{})
	pulumi.RegisterOutputType(PiImageMapOutput{})
}
